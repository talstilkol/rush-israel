...
| 24.2 | לחסום `__controlsTest` מ־shipping | **NOT DONE** | לא | `engine.ts` עדיין שם `window.__controlsTest` |
...
| # | פריט | סטטוס | ציון 100? | אמת |
|---|---|---|---|---|
| C1 | איילון 8+8+רכבת+6 מחלפים | **PARTIAL** | לא | נגד+ג'רזי ויזואלי. U-turn סינתטי. רכבת לא חיה מדויקת |
