...
1. Remaining 0/4 is sun intensity luma plus bakeEnv 0x3a9ae0 hue plus leftover
   ...
   independently of xr.setFoveation vs xr.setReferenceSpaceType vs
   PCFSoftShadowMap
   without changing product color, exposure or
   refreshing PNGs.
   Smoke must keep verifyWorldLayers through verifyWorldFrs. Live rest chase 7.4/1.92 must stay. Remaining pixel 0/4
   ...
   g07 empty-scene vs golden after xr.setFoveation/xr.setReferenceSpaceType/PCFSoftShadowMap neutralization. PNG refresh, threshold drift, color
...
2. Preserve the r6.18 Chromium install retry through the r6.84 lcc isolation,
   the r6.85 acd isolation, the r6.87 dsa isolation, the r6.88 tnc isolation, the r6.89 ldx isolation, the r6.90 sxo isolation, the r6.91 ftv isolation and the r6.92 frs isolation.
...
AUD-102 is the next RSH-036 isolation: leftover g07 empty-scene vs golden
independently of setOpaqueSort vs setTransparentSort vs xr.setCamera
...
Master plan r6.92 retains 67 units, 42 historical findings, 6 bundles and 101
