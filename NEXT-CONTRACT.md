...
## r6.77 and subsequent acceptance
1. Remaining 0/4 is sun intensity luma plus bakeEnv 0x3a9ae0 hue plus leftover
   ...
   independently of bloom vs SMAA vs post-pass graph
   without changing product color, exposure or
   refreshing PNGs.
   Smoke must keep verifyWorldLayers through verifyWorldPx. Live rest chase 7.4/1.92 must stay. Remaining pixel 0/4
   ...
   after pixelRatio/drawingBuffer/post.setSize neutralization. PNG refresh, threshold drift, color
...
2. Preserve the r6.18 Chromium install retry through the r6.76 chas isolation
   and the r6.77 px isolation.
...
AUD-88 is the next RSH-036 isolation: leftover g07 empty-scene vs golden
independently of bloom vs SMAA vs post-pass graph (product post pipeline
stays).
GFX-01, GFX-03, GFX-04, GFX-05, GFX-06, GFX-07 and GFX-08 stay
recorded only; do not start them before RSH-036 closes.

Master plan r6.77 retains 67 units, 42 historical findings, 6 bundles and 87
