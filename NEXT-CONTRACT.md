...
## r6.80 and subsequent acceptance
1. Remaining 0/4 is sun intensity luma plus bakeEnv 0x3a9ae0 hue plus leftover
   ...
   g07 empty-scene vs golden after shadowMap/fog/scissor neutralization. PNG refresh, threshold drift, color
...
2. Preserve the r6.18 Chromium install retry through the r6.79 aa isolation
   and the r6.80 sfs isolation.
...
AUD-91 is the next RSH-036 isolation: leftover g07 empty-scene vs golden
independently of autoClear vs sortObjects vs overrideMaterial (product
renderer stays).
GFX-01, GFX-03, GFX-04, GFX-05, GFX-06, GFX-07, GFX-08 and GFX-09 stay
recorded only; do not start them before RSH-036 closes.

Master plan r6.80 retains 67 units, 42 historical findings, 6 bundles and 90
