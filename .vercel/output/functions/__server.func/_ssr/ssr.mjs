...
import { C as getStylesheetHref, D as executeRewriteInput, E as _getRenderedMatches, F as isNotFound, I as require_react, M as isRedirect, N as isResolvedRedirect, O as invariant, P as rootRouteId, S as getScriptPreloadAttrs, T as resolveManifestCssLink, _ as require_jsx_runtime, a as isSsrResponse, c as stripSsrResponseBody, d as RouterProvider, i as disposeSsrResponseDetached, n as bindSsrResponseToRequest, o as normalizeSsrResponse, r as defineHandlerCallback, s as replaceSsrResponse, t as renderRouterToStream, w as resolveManifestAssetLink } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CHY7_81m.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BpHl7PX6.mjs").then((n) => n.t),
