	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			typeof location !== "undefined" && /(?:^|[?&])qa=1(?:&|$)/.test(location.search) ? /* @__PURE__ */ jsxs("p", {
				...
				children: [hud.backend, " · p50 ", Math.round(hud.msP50 || 0), " p95 ", Math.round(hud.msP95 || 0), " p99 ", Math.round(hud.msP99 || 0), "ms · dc ", hud.drawCalls || 0, " · tri ", (hud.triangles || 0) >= 1000 ? `${Math.round((hud.triangles || 0) / 1000)}k` : hud.triangles || 0, " · g", hud.geometries || 0, " t", hud.textures || 0, " · kin ", Number(hud.kinMix || 0).toFixed(2)]
			}) : null,
