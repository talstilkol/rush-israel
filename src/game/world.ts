...
export async function createWorld(def: TrackDef, built: BuiltTrack, shadows: boolean, night: boolean, weather: Weather = "clear") {
  ...
  const desertNight = def.theme === "desert" || def.theme === "snow" || def.theme === "stone" || def.theme === "jaffa" || def.theme === "carmel" || def.theme === "port" || def.theme === "bauhaus" || def.id === "ramon" || def.id === "hermon" || def.id === "scopus" || def.id === "golan" || def.id === "hw1" || def.id === "hw2" || def.id === "hw6" || def.id === "modiin";
  ...
  const crowdN = natureTrack || def.id === "ayalon" || def.id === "rothschild" || def.id === "hayarkon" || def.id === "oldjaffa" || def.id === "jerusalem" || def.id === "rishon" || def.id === "ramla" ? 0 : shadows ? 72 : 28;
  if (crowdN) {
