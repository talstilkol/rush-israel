...
export async function createWorld(def: TrackDef, built: BuiltTrack, shadows: boolean, night: boolean, weather: Weather = "clear") {
  ...
  if (def.theme !== "port" && def.theme !== "jaffa" && def.theme !== "stone") {
  ...
  if (def.theme !== "highway" && def.id !== "ayalon" && def.theme !== "desert" && def.theme !== "snow" && def.theme !== "carmel" && def.theme !== "port" && def.theme !== "jaffa" && def.theme !== "stone") {
