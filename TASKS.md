...
1.2.9. רכבת איילון על המדיאן של הספליין (לא קו GPS נפרד) — **DONE** (tiny).  
1.2.10. רציפי תחנות על המדיאן; בלי מיטת GPS כפולה — **DONE** (tiny).  
1.2.11. מחלפים ורמפות על הספליין (לא ציר עולם) — **DONE** (tiny).  
1.2.12. שלטי מחלף/תחנה עם שם עברי+אנגלי — **DONE** (tiny).  
1.2.13. קרקע: albedo בהיר × ground.png + repeat — **DONE** (tiny).  
1.2.14. כיפת אופק כחול שמיים, לא אפור — **DONE** (tiny).  
1.2.15. envMap לכל הרכבים (לא רק שחקן) — **DONE** (tiny).  
1.2.16. אי מרכזי באיילון (חצץ בין הכבישים) — **DONE** (tiny).  
1.2.17. 8 קווי נתיב על הכביש; בלי תעלת GPS — **DONE** (tiny).  
1.2.18. ג'רסי חיצוני בשני הכבישים באיילון — **DONE** (tiny).  
1.2.19. רכבת: רצועת חלונות + גג + שלט יעד — **DONE** (tiny).  
1.2.20. נחל איילון על הספליין (מערב לכביש) — **DONE** (tiny).  
1.2.21. קירות אקוסטיים בצד החיצוני — **DONE** (tiny).  
1.2.22. בלי אולמות GPS כפולים (סבידור/הגנה/אוניברסיטה) — **DONE** (tiny).  
1.2.23. עיניים מחזירות אור גם בכביש הנגדי — **DONE** (tiny).  
1.2.24. גשר/צינור השלום על הספליין — **DONE** (tiny).  
1.2.25. עמודי תמיכה מתחת לרמפות מחלף — **DONE** (tiny).  
1.2.26. סימוני אדום-לבן על השוליים — **DONE** (tiny).  
1.2.27. כביש מבריק ביום (wetness 0.22) — **DONE** (tiny).  
1.2.28. קניון רמת אביב מזרח לספליין, לא GPS על הנתיבים — **DONE** (tiny).  
1.2.29. IBM/יובל/פלטינום/אוניברסיטה מחוץ לנתיבים — **DONE** (tiny).  
1.2.30. שלטי תנועה גם בכביש הנגדי — **DONE** (tiny).  
1.2.31. סיפוני מחלף מכסים את שני הכבישים — **DONE** (tiny).  
1.2.32. קווים לבנים על רמפות המחלף — **DONE** (tiny).  
1.2.33. אספלט יום מבריק יותר (roughness 0.28) — **DONE** (tiny).  
1.2.34. תעלת איילון באי תנועה, לא מערב לנתיבים — **DONE** (tiny).  
1.2.35. כבל חשמלי מעל מסילת איילון — **DONE** (tiny).  
1.2.36. דפנות בטון לתעלת איילון — **DONE** (tiny).  
...
**1.2.36** דפנות תעלה. Freeze עדיין חסום.
