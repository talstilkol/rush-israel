...
**Version:** 1.4.0  
**Verified main baseline:** `d8259877740a2feab6533f1723fd21be8fb2f6c2`  
**Date:** 29 August 2026  
**Total:** 42 findings — 12 P0, 18 P1, 12 P2  
**Status:** 25 OPEN, 9 MITIGATED, 8 CLOSED
...
branch unprotected. A complete asset inventory does not establish legal clearance.
...
| P0-03 | P0 | **MITIGATED** | No branch-and-PR delivery workflow exists | RSH-001–RSH-010 use isolated branches and PRs; governance, CODEOWNERS and templates are merged. Live settings enforcement remains absent. | Apply the RSH-008 desired ruleset |
...
| P0-10 | P0 | **MITIGATED** | The last audit is stale and sequencing rules were violated | The queue was reset, product scope was frozen and all 56 tracks were classified; vertical-slice enforcement remains pending. | RSH-009, RSH-010, RSH-025 |
...
| P0-12 | P0 | **MITIGATED** | Root licensing and asset provenance are incomplete | RSH-011 inventories 134/134 public files and identifies 66 unverified asset files; root licence and evidence/replace decisions remain unresolved. | Finish RSH-011; RSH-012; replace or document unverified assets |
...
| P1-11 | P1 | **CLOSED** | The complete test suite is not part of the required validation gate | `required-ci / validate` executes complete `npm test`; exact-head validation continues to pass on accepted units. | RSH-007 |
...
| P2-01 | P2 | **OPEN** | Product metadata still references Israel and New York | Root metadata conflicts with the frozen Israel-focused Version 1. | RSH-012 |
