...
## r6.51 — 11 September 2026: combined leftover 0x808080 IBL is not PMREM vs constant cubemap

RSH-036 / PR39 remains unaccepted (35/67 accepted;32 remain). AUD-61 isolates
0x808080 background-only PMREM vs a constant 0x808080 CubeTexture vs IBL-off
independently of 0x3a9ae0 hue vs sun intensity vs fill after
setNight/snapCamera(true). r6.50 leftover 0x808080 background occupies B
−17.6/−19.3 of gray vs off −18.5/−20.2. g01/g05 day-bottom PMREM of 0x808080
≡ gray cubemap (ΔB +0.2/+0.3). A constant CubeTexture ≡ IBL-off (B
−18.5/−20.2). Leftover is specifically a PMREM-filtered gray environment versus
none. Hue occupies B −30.2/−32.8. Intensity occupies luma (−28.0/−31.1/−11.5).
Fill joins intensity on g08 night (−12.4). setNight does not rebake, so g08
night pmrem ≡ gray. g07 upper remains ramps. Camera stays 7.4/1.92. Freeze path
count stays 85. r6.27 lint no-undef is retained, not relabelled a pass.
Immutable CDN bytes, rendering performance and freeze remain open. Do not merge,
replace PNGs, change thresholds, retune color or exposure or activate RSH-037.
Details: RSH-036-WORLD-FLAT-r6.51.json, RSH-036-RUNTIME-REPAIR-r6.51.md and
docs/evidence/r6.27-published-ci-verification.json.

## r6.52 — 11 September 2026: leftover PMREM-filtered 0x808080 is not fromScene vs fromCubemap vs gain

RSH-036 / PR39 remains unaccepted (35/67 accepted;32 remain). AUD-62 isolates
fromScene of 0x808080 vs fromCubemap of the same gray vs environmentIntensity=0
independently of 0x3a9ae0 hue vs sun intensity vs fill after
setNight/snapCamera(true). r6.51 leftover PMREM-filtered 0x808080 occupies B
−18.5/−20.2 vs off. g01/g05 day-bottom fromScene ≡ gray cubemap (ΔB +0.2/+0.3).
fromCubemap ≡ environmentIntensity=0 ≡ IBL-off (B −18.5/−20.2). Leftover is
specifically fromScene of a gray Color background. Hue occupies B −30.2/−32.8.
Intensity occupies luma (−28.0/−31.1/−11.5). Fill joins intensity on g08 night
(−12.4). setNight does not rebake, so g08 night scene ≡ gray. g07 upper remains
ramps. Camera stays 7.4/1.92. Freeze path count stays 85. r6.27 lint no-undef is
retained, not relabelled a pass. Immutable CDN bytes, rendering performance and
freeze remain open. Do not merge, replace PNGs, change thresholds, retune color
...
## r6.57 — 11 September 2026: leftover gray cubemap vs IBL-off is not LightProbe vs MeshBasic envMap vs custom road-shader env

RSH-036 / PR39 remains unaccepted (35/67 accepted;32 remain). AUD-67 isolates
LightProbe intensity 0 vs MeshBasicMaterial envMap=null vs unbinding rush-road
onBeforeCompile on a 0x808080 fromScene independently of road vs all-standard
vs car envMapIntensity vs 0x3a9ae0 hue vs sun intensity vs fill after
setNight/snapCamera(true). r6.56 leftover fromScene of Color 0x808080 occupies
B −18.5/−20.2 vs off. g01/g05 day-bottom probe ≡ basic ≡ shader ≡ gray cubemap
(ΔB +0.2/+0.3). Leftover is not LightProbe versus MeshBasic envMap versus
custom road-shader env. Hue occupies B −30.2/−32.8. Intensity occupies luma
(−28.0/−31.1/−11.5). Fill joins intensity on g08 night (−12.4). setNight does
not rebake. g07 upper remains ramps. Camera stays 7.4/1.92. Freeze path count
stays 85. GFX-01 stays queued after RSH-036 and is not remaining 0/4. Do not
merge, replace PNGs, change thresholds, retune color or exposure or activate
RSH-037.
...
## r6.76 — 11 September 2026: leftover g07 after world.group+outside is remaining empty-scene vs golden, not follow, not height, not look-ahead, not env; GFX-08 queued

RSH-036 / PR39 remains unaccepted (35/67 accepted;32 remain). AUD-86 isolates
leftover g07 after world.group+outside as remaining empty-scene vs golden
independently of rest-chase follow vs height vs look-ahead after
setNight/snapCamera(true). g07 leftover is remaining empty-scene vs golden
(leftover 0.2027), not follow 14 (≡ 0, L2 ≡ 0), not height 4 (≡ 0), not
look-ahead (≡ 0) and not env (≡ 0). Empty leftover has no world geometry for
a chase-pose change to reproject. Product follow 7.4 / height 1.92 stay.
Freeze path count stays 85. GFX-01, GFX-03, GFX-04, GFX-05, GFX-06, GFX-07
and GFX-08 stay queued after RSH-036 and are not remaining 0/4. Do not
merge, replace PNGs, change thresholds, retune color or exposure or activate
RSH-037.
...
## r6.80 — 12 September 2026: leftover g07 after world.group+outside is remaining empty-scene vs golden, not shadowMap, not fog, not scissor, not env

RSH-036 / PR39 remains unaccepted (35/67 accepted;32 remain). AUD-90 isolates
leftover g07 after world.group+outside as remaining empty-scene vs golden
independently of shadowMap vs fog vs scissor after setNight/snapCamera(true).
g07 leftover is remaining empty-scene vs golden (leftover 0.2027), not
shadowMap off (≡ 0), not fog density 0 (≡ 0), not scissor 640×400 (≡ 0) and
not env (≡ 0). both ≡ pack ≡ 0. Empty leftover has no world geometry for a
shadow, fog or scissor change to occupy remaining g07. Product renderer
stays. Freeze path count stays 85. GFX-01, GFX-03, GFX-04, GFX-05, GFX-06,
GFX-07, GFX-08 and GFX-09 stay queued after RSH-036 and are not remaining
0/4. Do not merge, replace PNGs, change thresholds, retune color or exposure
or activate RSH-037.
...
## r6.82 — 12 September 2026: leftover g07 after world.group+outside is remaining empty-scene vs golden, not physicallyCorrectLights, not premultipliedAlpha, not logarithmicDepthBuffer, not env

RSH-036 / PR39 remains unaccepted (35/67 accepted;32 remain). AUD-92 isolates
leftover g07 after world.group+outside as remaining empty-scene vs golden
independently of physicallyCorrectLights vs premultipliedAlpha vs
logarithmicDepthBuffer after setNight/snapCamera(true). g07 leftover is
remaining empty-scene vs golden (leftover 0.2027), not physicallyCorrectLights
off (≡ 0), not premultipliedAlpha off (≡ 0), not logarithmicDepthBuffer on
(≡ 0) and not env (≡ 0). both ≡ pack ≡ 0. Empty leftover has no world geometry
for a physicallyCorrectLights, premultiply or log-depth change to occupy
remaining g07. Product renderer stays. Freeze path count stays 85. GFX-01,
GFX-03, GFX-04, GFX-05, GFX-06, GFX-07, GFX-08 and GFX-09 stay queued after
RSH-036 and are not remaining 0/4. Do not merge, replace PNGs, change
thresholds, retune color or exposure or activate RSH-037.
...
## r6.84 — 12 September 2026: leftover g07 after world.group+outside is remaining empty-scene vs golden, not localClippingEnabled, not clipShadows, not clipIntersection, not env

RSH-036 / PR39 remains unaccepted (35/67 accepted;32 remain). AUD-94 isolates
leftover g07 after world.group+outside as remaining empty-scene vs golden
independently of localClippingEnabled vs clipShadows vs clipIntersection after
setNight/snapCamera(true). g07 leftover is remaining empty-scene vs golden
(leftover 0.2027), not localClippingEnabled on (≡ 0), not clipShadows on (≡ 0),
not clipIntersection on (≡ 0) and not env (≡ 0). both ≡ pack ≡ 0. Empty
leftover has no world geometry for a localClipping/clipShadows/clipIntersection
...
## r6.88 — 12 September 2026: leftover g07 after world.group+outside is remaining empty-scene vs golden, not shadowMap.type, not shadowMap.needsUpdate, not clippingPlanes, not env

RSH-036 / PR39 remains unaccepted (35/67 accepted;32 remain). AUD-97 isolates
leftover g07 after world.group+outside as remaining empty-scene vs golden
independently of shadowMap.type vs shadowMap.needsUpdate vs clippingPlanes after
setNight/snapCamera(true). g07 leftover is remaining empty-scene vs golden
(leftover 0.2027), not BasicShadowMap (≡ 0), not shadowMap.needsUpdate on (≡ 0),
not clippingPlanes (≡ 0) and not env (≡ 0). both ≡ pack ≡ 0. Empty
leftover has no world geometry for a shadowMap.type/needsUpdate/clippingPlanes
change to occupy remaining g07. Product renderer stays. Freeze path count stays 85.
GFX-01, GFX-03, GFX-04, GFX-05, GFX-06, GFX-07, GFX-08 and GFX-09 stay queued
after RSH-036 and are not remaining 0/4. Do not merge, replace PNGs, change
thresholds, retune color or exposure or activate RSH-037.
...
## r6.92 — 12 September 2026: leftover g07 after world.group+outside is remaining empty-scene vs golden, not xr.setFoveation, not xr.setReferenceSpaceType, not PCFSoftShadowMap, not env

RSH-036 / PR39 remains unaccepted (35/67 accepted;32 remain). AUD-101 isolates
leftover g07 after world.group+outside as remaining empty-scene vs golden
independently of xr.setFoveation vs xr.setReferenceSpaceType vs PCFSoftShadowMap after
setNight/snapCamera(true). g07 leftover is remaining empty-scene vs golden
(leftover 0.2027), not setFoveation 0 (≡ 0), not setReferenceSpaceType viewer (≡ 0),
not PCFSoftShadowMap (≡ 0) and not env (≡ 0). both ≡ pack ≡ 0. Empty
leftover has no world geometry for a setFoveation/setReferenceSpaceType/PCFSoft
change to occupy remaining g07. Product renderer stays. Freeze path count stays 85.
GFX-01, GFX-03, GFX-04, GFX-05, GFX-06, GFX-07, GFX-08, GFX-09 and GFX-10 stay queued
after RSH-036 and are not remaining 0/4. Do not merge, replace PNGs, change
thresholds, retune color or exposure or activate RSH-037.
Details: RSH-036-WORLD-FRS-r6.92.json and RSH-036-RUNTIME-REPAIR-r6.92.md.

## r6.93 — 12 September 2026: leftover g07 after world.group+outside is remaining empty-scene vs golden, not setOpaqueSort, not setTransparentSort, not setClearAlpha, not env

RSH-036 / PR39 remains unaccepted (35/67 accepted;32 remain). AUD-102 isolates
leftover g07 after world.group+outside as remaining empty-scene vs golden
independently of setOpaqueSort vs setTransparentSort vs setClearAlpha after
setNight/snapCamera(true). g07 leftover is remaining empty-scene vs golden
(leftover 0.2027), not setOpaqueSort reverse (≡ 0), not setTransparentSort reverse (≡ 0),
not setClearAlpha 1 (≡ 0) and not env (≡ 0). both ≡ pack ≡ 0. Empty
leftover has no world geometry for a setOpaqueSort/setTransparentSort/setClearAlpha
change to occupy remaining g07. Product renderer stays. Freeze path count stays 85.
GFX-01, GFX-03, GFX-04, GFX-05, GFX-06, GFX-07, GFX-08, GFX-09 and GFX-10 stay queued
after RSH-036 and are not remaining 0/4. Do not merge, replace PNGs, change
thresholds, retune color or exposure or activate RSH-037.
...
## r6.97 — 12 September 2026: leftover g07 after world.group+outside is remaining empty-scene vs golden, not setRenderTarget, not setScissorTest, not info.reset, not env

RSH-036 / PR39 remains unaccepted (35/67 accepted;32 remain). AUD-104 isolates
leftover g07 after world.group+outside as remaining empty-scene vs golden
independently of setRenderTarget vs setScissorTest vs info.reset after
setNight/snapCamera(true). g07 leftover is remaining empty-scene vs golden
(leftover 0.2027), not setRenderTarget dummy (g07 +0.7602 increases), not
setScissorTest (≡ 0), not info.reset (≡ 0) and not env (≡ 0). both/pack follow
the dummy target on g07 (+0.7602). Empty leftover has no world geometry for a
setRenderTarget/setScissorTest/info.reset change to occupy remaining g07.
Product renderer stays. Freeze path count stays 85.
GFX-01, GFX-03, GFX-04, GFX-05, GFX-06, GFX-07, GFX-08, GFX-09 and GFX-10 stay queued
after RSH-036 and are not remaining 0/4. Do not merge, replace PNGs, change
thresholds, retune color or exposure or activate RSH-037.
Details: RSH-036-WORLD-RSI-r6.97.json and RSH-036-RUNTIME-REPAIR-r6.97.md.
