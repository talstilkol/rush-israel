...
9. The standing owner instruction to finish the master plan authorised remaining deferred units serially. RSH-039 is consumed on validated merge; RSH-040 is not authorised until that merge.

## 5. Post-RSH-039 program state
...
Ghosts remain byte-preserved and remain assigned outside this unit. The RSH-039 one-unit authority is consumed on merge. RSH-040 remains deferred and cannot start without a new explicit owner instruction after this merge.
