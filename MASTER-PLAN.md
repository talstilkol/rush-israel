...
9. The standing owner instruction to finish the master plan authorised remaining deferred units serially. RSH-040 is consumed on validated merge; RSH-041 is not authorised until that merge.

## 5. Post-RSH-040 program state
...
| Deferred | 27 |
| Remaining | 27 |
| Queue head | RSH-041 — deferred/not authorised |
| Active PR | none |
| RSH-040 one-unit authority | 1/1 — consumed |
...
Ghosts remain byte-preserved and remain assigned outside this unit. The RSH-040 one-unit authority is consumed on merge. RSH-041 remains deferred and cannot start without a new explicit owner instruction after this merge.
