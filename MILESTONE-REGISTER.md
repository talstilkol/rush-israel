...
**Next scheduled unit:** RSH-023 — deferred and not authorised
...
| M4 | Data integrity and production security | RSH-021–RSH-024 | 4 | ACTIVE — 2/4 accepted | Save data is recoverable and production has no debug or secret exposure. |
...
| Active PR | none |
| Remaining units | 45 |
| RSH-022 one-unit authority | consumed 1/1 |
...
| RSH-022 | Verified one-generation backup, bounded rejected-byte quarantine, explicit recovery and accessible visible failure handling accepted on validated merge |

No RSH-023 branch, PR or implementation structure is authorised by this state.
