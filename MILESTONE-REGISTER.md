...
**Next scheduled unit:** RSH-031 — deferred and not authorised
...
| Active PR | none |
| Remaining units | 37 |
| RSH-030 one-unit authority | consumed 1/1 |
...
No RSH-031 branch, PR or implementation structure is authorised by this state.
