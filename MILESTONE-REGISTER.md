...
| M2 | Product scope, licensing and assets | RSH-009–RSH-012 | 4 | ACTIVE — RSH-011 | Version 1 scope and every shipped asset's legal status are explicit. |
...
required status checks and zero rulesets. M1's exit gate remains **BLOCKED** until
live repository metadata confirms protection.
...
| RSH-010 — 8 MVP / 48 deferred catalogue classification | ACCEPTED — PR #13; PR #12 closed unmerged |
| RSH-011 — complete asset provenance and licence inventory | IN REVIEW — PR #14 |
| RSH-012 — README, metadata, branding, root licence and PWA alignment | AUTHORISED, BLOCKED BY RSH-011 |

RSH-011 inventories all 134 public files. It records 131 asset files and 66
unverified assets. Inventory coverage may complete while legal clearance remains
blocked; this distinction is mandatory.
