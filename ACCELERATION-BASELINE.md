...
## RSH-033 live qa:accel lab

Timing starts after `speed > 0.5 m/s` and stops at `27.778 m/s`. Means are three-run 50 ms quantized lab results.

| Car | Claim | Live mean | Claim band | Status |
|---|---:|---:|---|---|
| Sabra | 8.40 s | 8.40 s | 7.14–9.66 s | PASS |
| Carmel | 6.60 s | 6.60 s | 5.61–7.59 s | PASS |
| Kfir | 4.90 s | 4.90 s | 4.17–5.64 s | PASS |
| Negev | 5.80 s | 5.75 s | 4.93–6.67 s | PASS |
| Yam | 3.50 s | 3.45 s | 2.98–4.03 s | PASS |

The committed golden baseline uses these live means.
