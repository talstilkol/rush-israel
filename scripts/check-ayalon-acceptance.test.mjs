...
test("committed RSH-025 Ayalon acceptance authority passes under the RSH-029 overlay and RSH-034 remains absent", () => {
...
test("RSH-034 precreation fails closed", () => {
  const result = validateAyalonAcceptance({
    repositoryFiles: ["RSH-034-PREFLIGHT.json", "src/game/tracks/ayalon.ts"],
  });
