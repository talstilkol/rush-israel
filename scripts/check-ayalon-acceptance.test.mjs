...
test("committed RSH-025 Ayalon acceptance authority passes under the RSH-027 overlay and RSH-028 remains absent", () => {
...
test("RSH-028 precreation fails closed", () => {
  const result = validateAyalonAcceptance({
    repositoryFiles: ["RSH-028-PREFLIGHT.json", "src/game/tracks/ayalon.ts"],
  });
