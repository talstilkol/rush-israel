...
test("committed RSH-025 Ayalon acceptance authority passes under the RSH-029 overlay and RSH-045 remains absent", () => {
...
test("RSH-045 precreation fails closed", () => {
  const result = validateAyalonAcceptance({
    repositoryFiles: ["RSH-045-PREFLIGHT.json", "src/game/tracks/ayalon.ts"],
  });
