...
test("committed RSH-025 Ayalon acceptance authority passes under the RSH-029 overlay and RSH-035 remains absent", () => {
...
test("RSH-035 precreation fails closed", () => {
  const result = validateAyalonAcceptance({
    repositoryFiles: ["RSH-035-PREFLIGHT.json", "src/game/tracks/ayalon.ts"],
  });
