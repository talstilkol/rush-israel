...
export const EXPECTED_MANIFEST_SHA256 = "02ab7b8b1aa0ab100c0667caad205ea9ca9c4df533a888bbd48d62bc9c6e94b6";
...
export const EXPECTED_CONTRACT_SHA256 = "b775188c9b43f716a178a35e63136b6f8434f8d2eb0e66b17891bab0e0d2837b";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "15058da669817bd237e35564eca4b6d0bb69acffd182bcd109e24032662a1f27";
...
export function validatePerfBudgets(overrides = {}) {
  ...
  if (!/\| P2-09 \| P2 \| \*\*CLOSED\*\*/.test(input.findingsSource)) errors.push("P2-09 must close once budgets are locked");
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-040" || manifest.deferred_boundary?.rsh_040_authorized !== false || manifest.deferred_boundary?.rsh_040_started !== false) errors.push("RSH-040 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`perf-budgets ok: cache/streaming/draw-call budgets locked; RSH-040 deferred`);
}
