...
export const EXPECTED_MANIFEST_SHA256 = "4a25370e86ccd82ed76dda26f09677a11e53c50ee76689b2040d0ee67dcd69fe";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "f5d4770a54899ef433f4eef7969e7216be8a676a3e9ffbc1624ec41d294eccaf";
...
export function validatePerfBudgets(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-045" || manifest.deferred_boundary?.rsh_040_authorized !== true || manifest.deferred_boundary?.rsh_041_authorized !== true || manifest.deferred_boundary?.rsh_042_authorized !== true || manifest.deferred_boundary?.rsh_043_authorized !== true || manifest.deferred_boundary?.rsh_045_authorized !== false || manifest.deferred_boundary?.rsh_040_started !== true || manifest.deferred_boundary?.rsh_041_started !== true || manifest.deferred_boundary?.rsh_042_started !== true || manifest.deferred_boundary?.rsh_043_started !== true || manifest.deferred_boundary?.rsh_045_started !== false) errors.push("RSH-045 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`perf-budgets ok: cache/streaming/draw-call budgets locked; RSH-045 deferred`);
}
