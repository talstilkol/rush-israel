...
export const EXPECTED_MANIFEST_SHA256 = "4243ce7f4a8a6fd58841190a5ce78a4d6d4a9a90535fd5f8775c3a193f774b9e";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "e236564e0d0d17785c282af2cc5eeb259f164a924c1536f20de76c5d0d1ea258";
...
export function validatePerfBudgets(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-041" || manifest.deferred_boundary?.rsh_040_authorized !== true || manifest.deferred_boundary?.rsh_041_authorized !== false || manifest.deferred_boundary?.rsh_040_started !== true || manifest.deferred_boundary?.rsh_041_started !== false) errors.push("RSH-041 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`perf-budgets ok: cache/streaming/draw-call budgets locked; RSH-041 deferred`);
}
