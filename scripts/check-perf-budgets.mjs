...
export const EXPECTED_MANIFEST_SHA256 = "03d6505123d5c2e6614ded7233fcc03c315da6f96a34a191b27a1f83e1af7ee8";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "3eb20dfda99ea2ffd946be6fdfb41c4288ee36e9eaf9e4a8e62ccde3ca19ba09";
...
export function validatePerfBudgets(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-044" || manifest.deferred_boundary?.rsh_040_authorized !== true || manifest.deferred_boundary?.rsh_041_authorized !== true || manifest.deferred_boundary?.rsh_042_authorized !== true || manifest.deferred_boundary?.rsh_043_authorized !== true || manifest.deferred_boundary?.rsh_044_authorized !== false || manifest.deferred_boundary?.rsh_040_started !== true || manifest.deferred_boundary?.rsh_041_started !== true || manifest.deferred_boundary?.rsh_042_started !== true || manifest.deferred_boundary?.rsh_043_started !== true || manifest.deferred_boundary?.rsh_044_started !== false) errors.push("RSH-044 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`perf-budgets ok: cache/streaming/draw-call budgets locked; RSH-044 deferred`);
}
