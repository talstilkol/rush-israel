...
test("committed RSH-028 Ayalon landmark lock passes under the RSH-029 overlay and RSH-037 remains absent", () => {
...
test("RSH-037 precreation fails closed", () => {
  const result = validateAyalonLandmarks({
    repositoryFiles: ["RSH-037-PREFLIGHT.json", "src/game/ayalon-landmarks/landmarks.ts"],
  });
