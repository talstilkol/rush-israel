...
test("committed RSH-028 Ayalon landmark lock passes under the RSH-029 overlay and RSH-035 remains absent", () => {
...
test("RSH-035 precreation fails closed", () => {
  const result = validateAyalonLandmarks({
    repositoryFiles: ["RSH-035-PREFLIGHT.json", "src/game/ayalon-landmarks/landmarks.ts"],
  });
