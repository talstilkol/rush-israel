...
test("committed RSH-028 Ayalon landmark lock passes under the RSH-029 overlay and RSH-034 remains absent", () => {
...
test("RSH-034 precreation fails closed", () => {
  const result = validateAyalonLandmarks({
    repositoryFiles: ["RSH-034-PREFLIGHT.json", "src/game/ayalon-landmarks/landmarks.ts"],
  });
