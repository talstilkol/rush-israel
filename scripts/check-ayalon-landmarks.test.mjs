...
test("committed RSH-028 Ayalon landmark lock passes under the RSH-029 overlay and RSH-036 remains absent", () => {
...
test("RSH-036 precreation fails closed", () => {
  const result = validateAyalonLandmarks({
    repositoryFiles: ["RSH-036-PREFLIGHT.json", "src/game/ayalon-landmarks/landmarks.ts"],
  });
