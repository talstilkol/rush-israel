...
import { verifyWorldUpper } from './world-upper-browser.mjs';
import { verifyWorldRenv } from './world-renv-browser.mjs';
...
import { verifyWorldOgrp } from './world-ogrp-browser.mjs';
...
import { verifyWorldFx } from './world-fx-browser.mjs';
import { verifyWorldAa } from './world-aa-browser.mjs';
...
import { verifyWorldLcc } from './world-lcc-browser.mjs';
import { verifyWorldAcd } from './world-acd-browser.mjs';
...
import { verifyWorldRsi } from './world-rsi-browser.mjs';
...
try {
  ...
  results.push(...await verifyWorldUpper(browser, url));
  results.push(...await verifyWorldRenv(browser, url));
  ...
  results.push(...await verifyWorldOgrp(browser, url));
  ...
  results.push(...await verifyWorldFx(browser, url));
  results.push(...await verifyWorldAa(browser, url));
  ...
  results.push(...await verifyWorldLcc(browser, url));
  results.push(...await verifyWorldAcd(browser, url));
  ...
  results.push(...await verifyWorldRsi(browser, url));
