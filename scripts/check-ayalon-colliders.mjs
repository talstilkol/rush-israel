...
export const EXPECTED_MANIFEST_SHA256 = "a97eb5d2d97debc46cfc454be5565b759ebe18fdaa33254601b38227d71a50e9";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "52475942e0314577c88d1f3f4744ed1f9147d7e9ad3c8989912e2799f43bf8d1";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`ayalon-colliders ok: ${result.trackId}; ${result.rampCount} ramps; ${result.checkpointCount} checkpoints; ${result.interchangeCount} interchanges; RSH-028 deferred`);
}
