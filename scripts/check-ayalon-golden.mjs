...
export const EXPECTED_MANIFEST_SHA256 = "a676cbc4a9f723c2cf96c01aaafd5cd40b31d64ab61d14f6ab0a8a11b431e83d";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "c730147b76828fb61daae49242838d6d09ba0b0c67cd358977665be9eb68dea1";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`ayalon-golden ok: ${result.uniqueCount} unique frames; ${result.placeholderCount} placeholders; approved ${result.approved}; RSH-046 deferred`);
}
