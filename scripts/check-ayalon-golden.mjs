...
export const EXPECTED_MANIFEST_SHA256 = "0e75250898abe9a76aad9ee7fd2c1d0424030457cf8e42fcff08daa42b22f589";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "f65bc5d7da109823810ae67715c96ac9457fa428727bdb8b1457123ad579469e";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`ayalon-golden ok: ${result.uniqueCount} unique frames; ${result.placeholderCount} placeholders; approved ${result.approved}; RSH-047 deferred`);
}
