...
export const EXPECTED_MANIFEST_SHA256 = "405a96b62b5c7df23366f5947ff3f72be0ac80a77646c33dd5badcbf07343e4b";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "c80078a9a714a3c29f391dda6670ea466e468b154d53bb92bee5d6f91233288c";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`ayalon-golden ok: ${result.uniqueCount} unique frames; ${result.placeholderCount} placeholders; approved ${result.approved}; RSH-044 deferred`);
}
