...
export const EXPECTED_MANIFEST_SHA256 = "818a68058b9b9eab2263f98c4e8e27f4165e29b820269eaf5399e6848f24a60a";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "52df637c0c78c498eeaa3cc75e24041454b15b0f8409267bdd0ed8103072dfec";
...
export function validateAyalonGolden(overrides = {}) {
  ...
  if (
    ...
    || manifest.deferred_boundary?.rsh_036_started !== true || manifest.deferred_boundary?.rsh_037_started !== true || manifest.deferred_boundary?.rsh_038_started !== true || manifest.deferred_boundary?.rsh_039_started !== true || manifest.deferred_boundary?.rsh_040_started !== true || manifest.deferred_boundary?.rsh_041_started !== false
  ) {
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`ayalon-golden ok: ${result.uniqueCount} unique frames; ${result.placeholderCount} placeholders; approved ${result.approved}; RSH-041 deferred`);
}
