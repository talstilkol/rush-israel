...
export const EXPECTED_MANIFEST_SHA256 = "97e4dc8552e89f3be4a8895781dfa55ad93a1465ecfc24d18a46c81c5bc8fab0";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "a8950f1a1178cbd0fe1f9ed97734e1dcc438a54abd8f526556135aa9c5ea8e58";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`ayalon-golden ok: ${result.uniqueCount} unique frames; ${result.placeholderCount} placeholders; approved ${result.approved}; RSH-045 deferred`);
}
