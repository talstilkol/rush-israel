...
export const EXPECTED_MANIFEST_SHA256 = "4b79528c3f2ff33b0c613f3c4ca02a39902ac1c8c266f4efad5ff899861050ef";
export const EXPECTED_FREEZE_SHA256 = "d2c53d00b5781ed192a75436508115da8cbf35da6b72eb1249b141072c98930a";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "28fc007c15b971cecb21dee3ff5cac13d87a7cd61d761a6f1c6a1d125418e5a6";
export const EXPECTED_PACKAGE_SHA256 = "ae427c122d1e8f4a7b419fa83e7deaab7bfb5c88f200699182f8e3d85cf9df94";
export const EXPECTED_FREEZE_DIGEST_SHA256 = "4ce5c8c801b11a90a2827cb0ac654ea0a117d5857d8388033a51dffed1ed9e01";
...
export function validateAyalonFreeze(overrides = {}) {
  ...
  if (manifest.lock?.source_count !== 85) errors.push("transitive source count changed");
  ...
  if (Object.keys(files).length !== 85) errors.push("transitive source inventory changed");
