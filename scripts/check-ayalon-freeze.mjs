...
export const EXPECTED_MANIFEST_SHA256 = "b40dbaf01d4ab2e55e016992331c7409072ecb93793d3cc350c319bbf9fef014";
export const EXPECTED_FREEZE_SHA256 = "d714e39ca883f485db7208867af5f111558ddf16afbe495cfaf5b544006e61a1";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "74673e0e91c52b6d66545108fb50de579931ee63091ec6ff1bb5673ae56134c3";
export const EXPECTED_PACKAGE_SHA256 = "ae427c122d1e8f4a7b419fa83e7deaab7bfb5c88f200699182f8e3d85cf9df94";
export const EXPECTED_FREEZE_DIGEST_SHA256 = "af5a1f9e141f91536fe57fd959f1da4c9de115ceb456ae60884142bbe08465ce";
...
export function validateAyalonFreeze(overrides = {}) {
  ...
  if (manifest.lock?.source_count !== 78) errors.push("transitive source count changed");
  ...
  if (Object.keys(files).length !== 78) errors.push("transitive source inventory changed");
