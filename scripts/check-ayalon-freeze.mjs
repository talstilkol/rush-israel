...
export const EXPECTED_MANIFEST_SHA256 = "e8e2f4394efc672c07aebc106fe6c34bc78d24e732d9140e312803cb3db94272";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "732e99143a272234610a3d2bac8dd390957766c615ca5e903270dd7c6c93f467";
...
export function validateAyalonFreeze(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-039" || manifest.deferred_boundary?.rsh_037_authorized !== true || manifest.deferred_boundary?.rsh_038_authorized !== true || manifest.deferred_boundary?.rsh_039_authorized !== false || manifest.deferred_boundary?.rsh_037_started !== true || manifest.deferred_boundary?.rsh_038_started !== true || manifest.deferred_boundary?.rsh_039_started !== false) errors.push("RSH-039 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`ayalon-freeze ok: frozen ${result.frozen}; ${result.sourceCount} hashed sources; RSH-039 deferred`);
}
