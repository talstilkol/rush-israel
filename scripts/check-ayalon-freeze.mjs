...
export const EXPECTED_MANIFEST_SHA256 = "aa189c5100313a7d14a2b859c555ddfe0327776eb169ed83048c0db5dc79fb7f";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "6b8da913ff9e35977da95bf2736bb872034ac47037b9f639aef978c3242b9280";
...
export function validateAyalonFreeze(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-045" || manifest.deferred_boundary?.rsh_037_authorized !== true || manifest.deferred_boundary?.rsh_038_authorized !== true || manifest.deferred_boundary?.rsh_039_authorized !== true || manifest.deferred_boundary?.rsh_040_authorized !== true || manifest.deferred_boundary?.rsh_041_authorized !== true || manifest.deferred_boundary?.rsh_042_authorized !== true || manifest.deferred_boundary?.rsh_043_authorized !== true || manifest.deferred_boundary?.rsh_045_authorized !== false || manifest.deferred_boundary?.rsh_037_started !== true || manifest.deferred_boundary?.rsh_038_started !== true || manifest.deferred_boundary?.rsh_039_started !== true || manifest.deferred_boundary?.rsh_040_started !== true || manifest.deferred_boundary?.rsh_041_started !== true || manifest.deferred_boundary?.rsh_042_started !== true || manifest.deferred_boundary?.rsh_043_started !== true || manifest.deferred_boundary?.rsh_045_started !== false) errors.push("RSH-045 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`ayalon-freeze ok: frozen ${result.frozen}; ${result.sourceCount} hashed sources; RSH-045 deferred`);
}
