...
export const EXPECTED_MANIFEST_SHA256 = "4bd60871d7cc7af11299f022928bd33a33ba7bedaa81d065adc390ec480a0e85";
export const EXPECTED_FREEZE_SHA256 = "2624e00b25a670b8df59d747886c96fe1956cee5e2151c44f0f1a4cdcd78e35b";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "eaa54e403899076dc9258eba806864d18a56f87f430b071de266502c429b890f";
export const EXPECTED_PACKAGE_SHA256 = "ae427c122d1e8f4a7b419fa83e7deaab7bfb5c88f200699182f8e3d85cf9df94";
export const EXPECTED_FREEZE_DIGEST_SHA256 = "fae73bf44c153363a83ba17850d92ac11a35d300a5d3353f6168ccaae6c4d9d2";
...
export function validateAyalonFreeze(overrides = {}) {
  ...
  if (manifest.lock?.source_count !== 73) errors.push("transitive source count changed");
  ...
  if (Object.keys(files).length !== 73) errors.push("transitive source inventory changed");
