...
export const EXPECTED_MANIFEST_SHA256 = "6ae688273ac33b35784932ca971f6487b2ec7c484ba0455d599795315887ac61";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "d9bd997d8c5657c93e114175b49baef8dce374b02316adeea2a2723e77cc686d";
...
export function validateAyalonFreeze(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-044" || manifest.deferred_boundary?.rsh_037_authorized !== true || manifest.deferred_boundary?.rsh_038_authorized !== true || manifest.deferred_boundary?.rsh_039_authorized !== true || manifest.deferred_boundary?.rsh_040_authorized !== true || manifest.deferred_boundary?.rsh_041_authorized !== true || manifest.deferred_boundary?.rsh_042_authorized !== true || manifest.deferred_boundary?.rsh_043_authorized !== true || manifest.deferred_boundary?.rsh_044_authorized !== false || manifest.deferred_boundary?.rsh_037_started !== true || manifest.deferred_boundary?.rsh_038_started !== true || manifest.deferred_boundary?.rsh_039_started !== true || manifest.deferred_boundary?.rsh_040_started !== true || manifest.deferred_boundary?.rsh_041_started !== true || manifest.deferred_boundary?.rsh_042_started !== true || manifest.deferred_boundary?.rsh_043_started !== true || manifest.deferred_boundary?.rsh_044_started !== false) errors.push("RSH-044 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`ayalon-freeze ok: frozen ${result.frozen}; ${result.sourceCount} hashed sources; RSH-044 deferred`);
}
