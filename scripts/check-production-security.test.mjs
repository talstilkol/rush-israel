...
test("committed RSH-024 production-security authority passes under the RSH-029 overlay and RSH-034 remains absent", () => {
...
test("RSH-034 precreation fails closed", () => {
  const result = validateProductionSecurity({
    repositoryFiles: ["RSH-034-PREFLIGHT.json", "src/game/security/production-policy.ts"],
  });
