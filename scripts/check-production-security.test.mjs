...
test("committed RSH-024 production-security authority passes under the RSH-029 overlay and RSH-033 remains absent", () => {
...
test("RSH-033 precreation fails closed", () => {
  const result = validateProductionSecurity({
    repositoryFiles: ["RSH-033-PREFLIGHT.json", "src/game/security/production-policy.ts"],
  });
  assert.match(messages(result), /RSH-033 was precreated/);
});
