...
test("committed RSH-024 production-security authority passes and RSH-025 remains absent", () => {
...
test("RSH-025 precreation fails closed", () => {
  const result = validateProductionSecurity({
    repositoryFiles: ["RSH-025-PREFLIGHT.json", "src/game/security/production-policy.ts"],
  });
