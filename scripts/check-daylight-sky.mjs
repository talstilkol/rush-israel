...
export const EXPECTED_MANIFEST_SHA256 = "351a81815055bf2cf4ba9598d972900867fb091460c494b3aa5e8c639c274d93";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "5f4d357c692e44730aeae0dcd71c47375db9111b76818b9aa2f3a8cb590b1ba2";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`daylight-sky ok: look ${result.look}; HDRI ${result.hdri}; IBL ${result.iblKind}; RSH-043 deferred`);
}
