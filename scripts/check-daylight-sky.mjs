...
export const EXPECTED_MANIFEST_SHA256 = "39f499fb4a7072d46eacb4d71d05d960797d2af32f68a4622e2b7bf11dcca0f5";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "039c2563cff1fc8051fcee3c73982355198b8ddbda0b471d5b8012a496fd58e9";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`daylight-sky ok: look ${result.look}; HDRI ${result.hdri}; IBL ${result.iblKind}; RSH-046 deferred`);
}
