...
export const EXPECTED_MANIFEST_SHA256 = "585ab4d283c6e51b63724b4817fdfd8259ae0b53447d5a2f65aa1e5caa435d19";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "035bf9f9e092e2124997f9f2002a12441983ba5f8b92f038e68151fab72c74c3";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`daylight-sky ok: look ${result.look}; HDRI ${result.hdri}; IBL ${result.iblKind}; RSH-045 deferred`);
}
