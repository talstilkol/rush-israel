...
export const EXPECTED_MANIFEST_SHA256 = "572a916b89766af6bf8486c564e9dd31d56f997f39f9ef584b25a6494dfc8fe0";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "07014db749c53f1bb0a05ded6c53befec74ba65590f6f4b0e6e5dcac17514df8";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`daylight-sky ok: look ${result.look}; HDRI ${result.hdri}; IBL ${result.iblKind}; RSH-035 deferred`);
}
