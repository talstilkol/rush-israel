...
export const EXPECTED_MANIFEST_SHA256 = "bf4935045899453c11d83bd2928ddf8cb5dbad08a8fb4b1909ba14e8670e75f0";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "1dd57e7610899acdf32688771b4014c824bf9f1464ba4fc0bbcd0dd7a475ac79";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`daylight-sky ok: look ${result.look}; HDRI ${result.hdri}; IBL ${result.iblKind}; RSH-044 deferred`);
}
