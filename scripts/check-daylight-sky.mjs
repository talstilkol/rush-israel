...
export const EXPECTED_MANIFEST_SHA256 = "4b66cc3efe55902907d5e95d4fef72f5572b443826f4272f9ca04715504dbd99";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "4990ac4fb5e958aa64d8fdd54adb38d636b2b1dbd8238e103dc5e393f44b5e75";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`daylight-sky ok: look ${result.look}; HDRI ${result.hdri}; IBL ${result.iblKind}; RSH-047 deferred`);
}
