...
export const EXPECTED_MANIFEST_SHA256 = "28d9ab616e27f468e758d8f7070a679bde4e8c073777c8253fbb1f7b96008f5b";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "91976028eb5f0144a5560465fb3f9b7ba34228c37fd227090efa70389822c6e1";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`daylight-sky ok: look ${result.look}; HDRI ${result.hdri}; IBL ${result.iblKind}; RSH-042 deferred`);
}
