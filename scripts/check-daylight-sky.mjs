...
export const EXPECTED_MANIFEST_SHA256 = "ac37c731d822b05fb30ef98e0f830554e3b52a6b78090a6ebe0e6dffc1666109";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "0901bb6dba8da21d160ae8f63e3fbf6f7d30555609457ceb7d52a67ec013391e";
...
export function validateDaylightSky(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-032" || manifest.deferred_boundary?.rsh_032_authorized !== false || manifest.deferred_boundary?.rsh_032_started !== false) errors.push("RSH-032 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`daylight-sky ok: look ${result.look}; HDRI ${result.hdri}; IBL ${result.iblKind}; RSH-032 deferred`);
}
