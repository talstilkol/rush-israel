...
export const EXPECTED_MANIFEST_SHA256 = "8723839e2735c86f82f8d578f8aedb7e6ca21868d5e919d8118ea91aabb564d5";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "aee0d989c0e1fd106e51fb9dd109ccde7104a58bc7c33ec8db60a27edf838ccc";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`daylight-sky ok: look ${result.look}; HDRI ${result.hdri}; IBL ${result.iblKind}; RSH-038 deferred`);
}
