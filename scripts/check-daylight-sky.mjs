...
export const EXPECTED_MANIFEST_SHA256 = "f6f0aea7be883103804230772a5853ce5264a5db26b8f1ca73fdd2cf1db57c26";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "37a4a1314a06cee454becd9b2ff7f1b215a979739e5493dfe8b189e2d67e2122";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`daylight-sky ok: look ${result.look}; HDRI ${result.hdri}; IBL ${result.iblKind}; RSH-039 deferred`);
}
