...
export const EXPECTED_MANIFEST_SHA256 = "b928e5348b8d6f7668d8f40327db4db4dce2502681a68e273904b93a05258d16";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "81b8722e03b516f42c064fde36e6686cbe5e7a43e4963bffe5c066905bbc8db9";
...
export function validatePerfInstrument(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-044" || manifest.deferred_boundary?.rsh_038_authorized !== true || manifest.deferred_boundary?.rsh_039_authorized !== true || manifest.deferred_boundary?.rsh_040_authorized !== true || manifest.deferred_boundary?.rsh_041_authorized !== true || manifest.deferred_boundary?.rsh_042_authorized !== true || manifest.deferred_boundary?.rsh_043_authorized !== true || manifest.deferred_boundary?.rsh_044_authorized !== false || manifest.deferred_boundary?.rsh_038_started !== true || manifest.deferred_boundary?.rsh_039_started !== true || manifest.deferred_boundary?.rsh_040_started !== true || manifest.deferred_boundary?.rsh_041_started !== true || manifest.deferred_boundary?.rsh_042_started !== true || manifest.deferred_boundary?.rsh_043_started !== true || manifest.deferred_boundary?.rsh_044_started !== false) errors.push("RSH-044 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`perf-instrument ok: p50/p95/p99 + draw/tri/memory; RSH-044 deferred`);
}
