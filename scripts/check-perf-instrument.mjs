...
export const EXPECTED_MANIFEST_SHA256 = "d806bb9699a58ed63210af3393f6f9886bddc3ce64070e60922c176bcc9bb59b";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "27dda0529819975ad6cf6cde0cb7388614714a0e4e118d2747c8d5977c2497b1";
...
export function validatePerfInstrument(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-041" || manifest.deferred_boundary?.rsh_038_authorized !== true || manifest.deferred_boundary?.rsh_039_authorized !== true || manifest.deferred_boundary?.rsh_040_authorized !== true || manifest.deferred_boundary?.rsh_041_authorized !== false || manifest.deferred_boundary?.rsh_038_started !== true || manifest.deferred_boundary?.rsh_039_started !== true || manifest.deferred_boundary?.rsh_040_started !== true || manifest.deferred_boundary?.rsh_041_started !== false) errors.push("RSH-041 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`perf-instrument ok: p50/p95/p99 + draw/tri/memory; RSH-041 deferred`);
}
