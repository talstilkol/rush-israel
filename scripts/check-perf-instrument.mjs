...
export const EXPECTED_MANIFEST_SHA256 = "5d81c9d195f003a1abc31841bdbe3070f6d0282a0c4692d1fcba7a62e5581fa8";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "587877716c7af657d5f560f747e283e41b58856f29127f3ce7a36b9a94012089";
...
export function validatePerfInstrument(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-042" || manifest.deferred_boundary?.rsh_038_authorized !== true || manifest.deferred_boundary?.rsh_039_authorized !== true || manifest.deferred_boundary?.rsh_040_authorized !== true || manifest.deferred_boundary?.rsh_041_authorized !== true || manifest.deferred_boundary?.rsh_042_authorized !== false || manifest.deferred_boundary?.rsh_038_started !== true || manifest.deferred_boundary?.rsh_039_started !== true || manifest.deferred_boundary?.rsh_040_started !== true || manifest.deferred_boundary?.rsh_041_started !== true || manifest.deferred_boundary?.rsh_042_started !== false) errors.push("RSH-042 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`perf-instrument ok: p50/p95/p99 + draw/tri/memory; RSH-042 deferred`);
}
