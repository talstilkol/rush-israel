...
export const EXPECTED_MANIFEST_SHA256 = "857392d7cfda35053e5d39d933cf9580692caa5e524baa6b35ec3dab1480fa5f";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "be62e09ad5042bf363215315202c3477b9a416e4b670f3ec27ad1c4dbe9db73d";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`production-security ok: build ${result.buildCommand}; ${result.patternCount} secret patterns; schema v${result.schemaVersion}; RSH-025 deferred`);
}
