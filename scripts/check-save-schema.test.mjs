...
test("the RSH-021 schema remains exact beneath the accepted RSH-022 recovery overlay", () => {
  ...
  assert.equal(manifest.deferred_boundary.rsh_024_started, true);
  assert.equal(manifest.deferred_boundary.rsh_024_authorized, true);
  assert.equal(manifest.deferred_boundary.rsh_024_state, "accepted_on_merge");
  ...
  assert.equal(manifest.deferred_boundary.rsh_027_authorized, true);
  assert.equal(manifest.deferred_boundary.rsh_028_started, true);
  assert.equal(manifest.deferred_boundary.rsh_028_authorized, true);
  assert.equal(manifest.deferred_boundary.rsh_029_started, true);
  ...
  assert.equal(manifest.deferred_boundary.rsh_032_started, true);
  assert.equal(manifest.deferred_boundary.rsh_032_authorized, true);
  assert.equal(manifest.deferred_boundary.rsh_033_started, true);
  assert.equal(manifest.deferred_boundary.rsh_033_authorized, true);
  assert.equal(manifest.deferred_boundary.rsh_034_started, true);
  assert.equal(manifest.deferred_boundary.rsh_034_authorized, true);
  assert.equal(manifest.deferred_boundary.rsh_035_started, true);
  assert.equal(manifest.deferred_boundary.rsh_035_authorized, true);
  assert.equal(manifest.deferred_boundary.rsh_036_started, true);
  assert.equal(manifest.deferred_boundary.rsh_036_authorized, true);
  assert.equal(manifest.deferred_boundary.rsh_037_started, true);
  assert.equal(manifest.deferred_boundary.rsh_038_started, true);
  assert.equal(manifest.deferred_boundary.rsh_039_started, true);
  assert.equal(manifest.deferred_boundary.rsh_040_started, true);
  assert.equal(manifest.deferred_boundary.rsh_041_started, true);
  assert.equal(manifest.deferred_boundary.rsh_042_started, true);
  assert.equal(manifest.deferred_boundary.rsh_043_started, true);
  assert.equal(manifest.deferred_boundary.rsh_044_started, true);
  assert.equal(manifest.deferred_boundary.rsh_045_started, true);
  assert.equal(manifest.deferred_boundary.rsh_046_started, true);
  assert.equal(manifest.deferred_boundary.rsh_047_started, false);
  assert.equal(manifest.deferred_boundary.rsh_037_authorized, true);
  assert.equal(manifest.deferred_boundary.rsh_038_authorized, true);
  assert.equal(manifest.deferred_boundary.rsh_039_authorized, true);
  assert.equal(manifest.deferred_boundary.rsh_040_authorized, true);
  assert.equal(manifest.deferred_boundary.rsh_041_authorized, true);
  assert.equal(manifest.deferred_boundary.rsh_042_authorized, true);
  assert.equal(manifest.deferred_boundary.rsh_043_authorized, true);
  assert.equal(manifest.deferred_boundary.rsh_044_authorized, true);
  assert.equal(manifest.deferred_boundary.rsh_045_authorized, true);
  assert.equal(manifest.deferred_boundary.rsh_046_authorized, true);
  assert.equal(manifest.deferred_boundary.rsh_047_authorized, false);
});
