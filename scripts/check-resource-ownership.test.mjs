...
test("RSH-021 precreation fails closed", () => {
  const input = baseline();
  input.repositoryFiles.push("RSH-021-PREFLIGHT.json");
  assert.match(messages(validateResourceOwnership(input)), /RSH-021 was precreated/);
});
