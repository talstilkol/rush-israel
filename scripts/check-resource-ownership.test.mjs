...
test("RSH-020 precreation fails closed", () => {
  const input = baseline();
  input.repositoryFiles.push("RSH-020-PREFLIGHT.json");
  assert.match(messages(validateResourceOwnership(input)), /RSH-020 was precreated/);
});
