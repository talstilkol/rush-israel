...
test("RSH-022 precreation fails closed", () => {
  const input = baseline();
  input.repositoryFiles.push("RSH-022-PREFLIGHT.json");
  assert.match(messages(validateResourceOwnership(input)), /RSH-022 was precreated/);
});
