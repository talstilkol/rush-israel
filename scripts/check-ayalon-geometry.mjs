...
export const EXPECTED_MANIFEST_SHA256 = "8fa09d40bb51c4428a4249cde094a92cd94f0a7bafbe8a818bdda8cbaabae40f";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "096fba930dd4042841670cb30a0aee47bd08d17d25acdce22476a150e8c72d89";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`ayalon-geometry ok: ${result.trackId}; width ${result.width}; ${result.lanes} lanes; ${result.pointCount} points; RSH-028 overlay accepted; RSH-029 deferred`);
}
