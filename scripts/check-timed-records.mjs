...
export const EXPECTED_MANIFEST_SHA256 = "109739609ad23347bbd7244e2c978dfbb71b01b401667e4f161ceb684615e347";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "3f13b5c7103792d0a4ff9d17ca93436a30a8c03f8ac393c6d02e37bda9ecb910";
...
export function validateTimedRecords(overrides = {}) {
  const input = { ...readTimedRecordsInputs(), ...overrides };
  const errors = [];
