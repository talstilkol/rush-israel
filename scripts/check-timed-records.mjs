...
export const EXPECTED_MANIFEST_SHA256 = "a7b5058e8cfc44c2f45609bfbb3d2e5717bd9e42f226c2701215a1002c7638b2";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "471591c422ae66ce98be84d0c2a3de533a731ec27511c2c1de0fb27f936b3077";
...
export function validateTimedRecords(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-029" || manifest.deferred_boundary?.rsh_027_authorized !== true || manifest.deferred_boundary?.rsh_027_started !== true || manifest.deferred_boundary?.rsh_028_authorized !== true || manifest.deferred_boundary?.rsh_028_started !== true || manifest.deferred_boundary?.rsh_029_authorized !== false || manifest.deferred_boundary?.rsh_029_started !== false) errors.push("RSH-029 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`timed-records ok: schema v${result.schemaVersion}; limit ${result.recordLimit}; per-car ${result.perTrackCarLimit}; RSH-028 overlay accepted; RSH-029 deferred`);
}
