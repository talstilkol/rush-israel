...
export const EXPECTED_MANIFEST_SHA256 = "a868408c0e2ddb40d25c20656cd6701323f2631e25218f58d22bc67b420d44ef";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "cbfd1fa87c91ce4afdfe1fa4091b6faed7d60e2178bf064be9f31bf54c680d50";
...
export function validateTimedRecords(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-028" || manifest.deferred_boundary?.rsh_027_authorized !== true || manifest.deferred_boundary?.rsh_027_started !== true || manifest.deferred_boundary?.rsh_028_authorized !== false || manifest.deferred_boundary?.rsh_028_started !== false) errors.push("RSH-028 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`timed-records ok: schema v${result.schemaVersion}; limit ${result.recordLimit}; per-car ${result.perTrackCarLimit}; RSH-027 overlay accepted; RSH-028 deferred`);
}
