...
export const EXPECTED_MANIFEST_SHA256 = "de4d7ce4ca153cd4ef069b27e7ca8533a3349d515372a897fda268978223c957";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "a4de2cb0dd8dc130be70791afb05ed344d4a4608186cef000393efc88af1e1bf";
...
export function validateTimedRecords(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-024" || manifest.deferred_boundary?.rsh_024_authorized !== false || manifest.deferred_boundary?.rsh_024_started !== false) errors.push("RSH-024 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`timed-records ok: schema v${result.schemaVersion}; limit ${result.recordLimit}; per-car ${result.perTrackCarLimit}; RSH-024 deferred`);
}
