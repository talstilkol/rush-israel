...
export const EXPECTED_MANIFEST_SHA256 = "d4533d7f1cd3771d1ddc9b07b5c765969bed8004728ab65eeb1a22c740fe63c8";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "2a1966b50be209f5bee6e4b1b6da8faeb83b8c3db5f02c0c0101afadc1b691b9";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`night-weather ok: look ${result.look}; HDRI ${result.hdri}; weather ${result.weatherDefault}; RSH-039 deferred`);
}
