...
export const EXPECTED_MANIFEST_SHA256 = "c5e3a5aa137a6f0d7f711bb532d8bf0b5d29f38511f9847f717adca7ae290e4a";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "8f1166cc599c668c7fe092c2682688ed0d289225e6569d2c481939607f7d1ed0";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`night-weather ok: look ${result.look}; HDRI ${result.hdri}; weather ${result.weatherDefault}; RSH-040 deferred`);
}
