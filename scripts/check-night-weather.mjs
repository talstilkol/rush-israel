...
export const EXPECTED_MANIFEST_SHA256 = "24d733efcf46b9f06f30da2fcc58986a4c2d25c30fe735a6f408662a8bed569f";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "b189b8cc46604cadfa4ae273109ae665a5ed2d2511346edab39adaf3895ec82e";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`night-weather ok: look ${result.look}; HDRI ${result.hdri}; weather ${result.weatherDefault}; RSH-044 deferred`);
}
