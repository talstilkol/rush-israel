...
export const EXPECTED_MANIFEST_SHA256 = "fe0b8077f41e0c4bf13ea1e6b38a10398fcb50f26043b7b51550b7b2c92a9f19";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "ffe1a2651102f9b1419904320c3fd74218e7a9bcf0dad1efa27cc24ff843f4db";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`night-weather ok: look ${result.look}; HDRI ${result.hdri}; weather ${result.weatherDefault}; RSH-043 deferred`);
}
