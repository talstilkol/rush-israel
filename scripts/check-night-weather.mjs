...
export const EXPECTED_MANIFEST_SHA256 = "b97077124c5dd57bedf3b7d7a84f477719d045c92fecff2e1448e83886d3e8e3";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "f96a585c387fb64e235d66ac94bf2276a6cf3a0428343908e98b00651fc5f14b";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`night-weather ok: look ${result.look}; HDRI ${result.hdri}; weather ${result.weatherDefault}; RSH-045 deferred`);
}
