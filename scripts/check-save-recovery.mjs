...
export const EXPECTED_MANIFEST_SHA256 = "71d759e319534f5e5a06d38b729e1aa2a7cb401b710c30f8205fac68432f2640";
...
export function validateSaveRecovery(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-032" || manifest.deferred_boundary?.rsh_023_authorized !== true || manifest.deferred_boundary?.rsh_023_started !== true || manifest.deferred_boundary?.rsh_024_started !== true || manifest.deferred_boundary?.rsh_025_started !== true || manifest.deferred_boundary?.rsh_026_started !== true || manifest.deferred_boundary?.rsh_027_started !== true || manifest.deferred_boundary?.rsh_028_started !== true || manifest.deferred_boundary?.rsh_029_started !== true || manifest.deferred_boundary?.rsh_030_started !== true || manifest.deferred_boundary?.rsh_031_started !== true) errors.push("RSH-032 deferred boundary changed");
