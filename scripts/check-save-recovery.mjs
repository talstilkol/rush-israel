...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`save-recovery ok: schema v${result.schemaVersion}; ${result.backupKeys} bounded keys; ${result.quarantineSlots} rejected-save slots; RSH-023 accepted; RSH-024 overlay accepted; RSH-025 overlay accepted; RSH-026 deferred`);
}
