...
export const EXPECTED_MANIFEST_SHA256 = "296955fb9f5a28ac8d9d22e2076090e548e1e60e1b9f7ab2606e36fe029a1449";
...
export function validateSaveRecovery(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-034" || manifest.deferred_boundary?.rsh_023_authorized !== true || manifest.deferred_boundary?.rsh_023_started !== true || manifest.deferred_boundary?.rsh_024_started !== true || manifest.deferred_boundary?.rsh_025_started !== true || manifest.deferred_boundary?.rsh_026_started !== true || manifest.deferred_boundary?.rsh_027_started !== true || manifest.deferred_boundary?.rsh_028_started !== true || manifest.deferred_boundary?.rsh_029_started !== true || manifest.deferred_boundary?.rsh_030_started !== true || manifest.deferred_boundary?.rsh_031_started !== true || manifest.deferred_boundary?.rsh_032_authorized !== true || manifest.deferred_boundary?.rsh_032_started !== true || manifest.deferred_boundary?.rsh_033_authorized !== true || manifest.deferred_boundary?.rsh_033_started !== true || manifest.deferred_boundary?.rsh_034_authorized !== false || manifest.deferred_boundary?.rsh_034_started !== false) errors.push("RSH-034 deferred boundary changed");
