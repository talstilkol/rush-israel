...
export const EXPECTED_MANIFEST_SHA256 = "79d3fb09035db47d072454fb67a7cafb0dc5d7ff2e4470513319d95d6faffd32";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "4f01f559d7baeeb7a37e48525116e8cce32deaf3ff9761d5d03b0adee8f9f2f7";
...
export function validateLeakCycles(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-045" || manifest.deferred_boundary?.rsh_041_authorized !== true || manifest.deferred_boundary?.rsh_042_authorized !== true || manifest.deferred_boundary?.rsh_043_authorized !== true || manifest.deferred_boundary?.rsh_045_authorized !== false || manifest.deferred_boundary?.rsh_041_started !== true || manifest.deferred_boundary?.rsh_042_started !== true || manifest.deferred_boundary?.rsh_043_started !== true || manifest.deferred_boundary?.rsh_045_started !== false) errors.push("RSH-045 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`leak-cycles ok: 20 enter-exit cycles locked; RSH-045 deferred`);
}
