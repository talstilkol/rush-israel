...
export const EXPECTED_MANIFEST_SHA256 = "43355008897ae3046f39b834b24189dc5a60c7dc02cbd397821f27822d1a4ebe";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "aee782c9283eebb111437a50dcf37129064d87b47fe571d6eb9b3627e5e57664";
...
export function validateLeakCycles(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-046" || manifest.deferred_boundary?.rsh_041_authorized !== true || manifest.deferred_boundary?.rsh_042_authorized !== true || manifest.deferred_boundary?.rsh_043_authorized !== true || manifest.deferred_boundary?.rsh_045_authorized !== true || manifest.deferred_boundary?.rsh_046_authorized !== false || manifest.deferred_boundary?.rsh_041_started !== true || manifest.deferred_boundary?.rsh_042_started !== true || manifest.deferred_boundary?.rsh_043_started !== true || manifest.deferred_boundary?.rsh_045_started !== true || manifest.deferred_boundary?.rsh_046_started !== false) errors.push("RSH-046 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`leak-cycles ok: 20 enter-exit cycles locked; RSH-046 deferred`);
}
