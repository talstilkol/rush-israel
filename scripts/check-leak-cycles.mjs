...
export const EXPECTED_MANIFEST_SHA256 = "e11388cf0256ff90c32472e321a0752b8eb63565401e16f535a1ea445d527ae3";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "5429f1d434eda4b99749e2dbae7b632eb381140f864435753a7b466da7168070";
...
export function validateLeakCycles(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-047" || manifest.deferred_boundary?.rsh_041_authorized !== true || manifest.deferred_boundary?.rsh_042_authorized !== true || manifest.deferred_boundary?.rsh_043_authorized !== true || manifest.deferred_boundary?.rsh_045_authorized !== true || manifest.deferred_boundary?.rsh_046_authorized !== true || manifest.deferred_boundary?.rsh_047_authorized !== false || manifest.deferred_boundary?.rsh_041_started !== true || manifest.deferred_boundary?.rsh_042_started !== true || manifest.deferred_boundary?.rsh_043_started !== true || manifest.deferred_boundary?.rsh_045_started !== true || manifest.deferred_boundary?.rsh_046_started !== true || manifest.deferred_boundary?.rsh_047_started !== false) errors.push("RSH-047 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`leak-cycles ok: 20 enter-exit cycles locked; RSH-047 deferred`);
}
