...
test("committed RSH-032 night/headlight/weather lock passes and RSH-040 remains absent", () => {
...
test("RSH-040 precreation fails closed", () => {
  const result = validateNightWeather({
    repositoryFiles: ["RSH-040-PREFLIGHT.json", "src/game/ayalon-night/night.ts"],
  });
