...
test("committed RSH-032 night/headlight/weather lock passes and RSH-044 remains absent", () => {
...
test("RSH-044 precreation fails closed", () => {
  const result = validateNightWeather({
    repositoryFiles: ["RSH-044-PREFLIGHT.json", "src/game/ayalon-night/night.ts"],
  });
