...
test("committed RSH-032 night/headlight/weather lock passes and RSH-045 remains absent", () => {
...
test("RSH-045 precreation fails closed", () => {
  const result = validateNightWeather({
    repositoryFiles: ["RSH-045-PREFLIGHT.json", "src/game/ayalon-night/night.ts"],
  });
