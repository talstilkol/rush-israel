...
test("committed RSH-032 night/headlight/weather lock passes and RSH-038 remains absent", () => {
...
test("RSH-038 precreation fails closed", () => {
  const result = validateNightWeather({
    repositoryFiles: ["RSH-038-PREFLIGHT.json", "src/game/ayalon-night/night.ts"],
  });
