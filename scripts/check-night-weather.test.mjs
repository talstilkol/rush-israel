...
test("committed RSH-032 night/headlight/weather lock passes and RSH-043 remains absent", () => {
...
test("RSH-043 precreation fails closed", () => {
  const result = validateNightWeather({
    repositoryFiles: ["RSH-043-PREFLIGHT.json", "src/game/ayalon-night/night.ts"],
  });
