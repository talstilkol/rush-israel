...
test("committed RSH-032 night/headlight/weather lock passes and RSH-039 remains absent", () => {
...
test("RSH-039 precreation fails closed", () => {
  const result = validateNightWeather({
    repositoryFiles: ["RSH-039-PREFLIGHT.json", "src/game/ayalon-night/night.ts"],
  });
