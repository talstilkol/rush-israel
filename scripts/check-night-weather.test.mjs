...
test("committed RSH-032 night/headlight/weather lock passes and RSH-036 remains absent", () => {
...
test("RSH-036 precreation fails closed", () => {
  const result = validateNightWeather({
    repositoryFiles: ["RSH-036-PREFLIGHT.json", "src/game/ayalon-night/night.ts"],
  });
