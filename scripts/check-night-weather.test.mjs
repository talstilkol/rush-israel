...
test("committed RSH-032 night/headlight/weather lock passes and RSH-033 remains absent", () => {
...
test("RSH-033 precreation fails closed", () => {
  const result = validateNightWeather({
    repositoryFiles: ["RSH-033-PREFLIGHT.json", "src/game/ayalon-night/night.ts"],
  });
