...
export const EXPECTED_MANIFEST_SHA256 = "3e7622168d4cbdd7fda0b9b14ec4c3c9245769f9ee563d598e4e58523b5cb251";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "9333ef34a8f05f8d7ed0e6a223c7aa2c66080ceaa8d2ca19214428c38d20d95a";
...
export function validateContextLoss(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-045" || manifest.deferred_boundary?.rsh_042_authorized !== true || manifest.deferred_boundary?.rsh_043_authorized !== true || manifest.deferred_boundary?.rsh_045_authorized !== false || manifest.deferred_boundary?.rsh_042_started !== true || manifest.deferred_boundary?.rsh_043_started !== true || manifest.deferred_boundary?.rsh_045_started !== false) errors.push("RSH-045 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`context-loss ok: 8 recovery cycles locked; RSH-045 deferred`);
}
