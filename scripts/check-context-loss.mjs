...
export const EXPECTED_MANIFEST_SHA256 = "fcf5198416a35aed2676a20228368d690ee32fd1502be5535593980801a8d17e";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "7a293ad93d791dbef2b471736cca25de1a4e23d6b2a4a8bd44c15153b7f346c8";
...
export function validateContextLoss(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-044" || manifest.deferred_boundary?.rsh_042_authorized !== true || manifest.deferred_boundary?.rsh_043_authorized !== true || manifest.deferred_boundary?.rsh_044_authorized !== false || manifest.deferred_boundary?.rsh_042_started !== true || manifest.deferred_boundary?.rsh_043_started !== true || manifest.deferred_boundary?.rsh_044_started !== false) errors.push("RSH-044 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`context-loss ok: 8 recovery cycles locked; RSH-044 deferred`);
}
