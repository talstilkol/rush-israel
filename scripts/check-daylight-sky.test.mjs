...
test("committed RSH-031 daylight/sky/IBL lock passes and RSH-043 remains absent", () => {
...
test("RSH-043 precreation fails closed", () => {
  const result = validateDaylightSky({
    repositoryFiles: ["RSH-043-PREFLIGHT.json", "src/game/ayalon-light/daylight.ts"],
  });
