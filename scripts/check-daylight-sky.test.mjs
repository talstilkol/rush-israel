...
test("committed RSH-031 daylight/sky/IBL lock passes and RSH-039 remains absent", () => {
...
test("RSH-039 precreation fails closed", () => {
  const result = validateDaylightSky({
    repositoryFiles: ["RSH-039-PREFLIGHT.json", "src/game/ayalon-light/daylight.ts"],
  });
