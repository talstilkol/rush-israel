...
test("committed RSH-031 daylight/sky/IBL lock passes and RSH-038 remains absent", () => {
...
test("RSH-038 precreation fails closed", () => {
  const result = validateDaylightSky({
    repositoryFiles: ["RSH-038-PREFLIGHT.json", "src/game/ayalon-light/daylight.ts"],
  });
