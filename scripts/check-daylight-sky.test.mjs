...
test("committed RSH-031 daylight/sky/IBL lock passes and RSH-047 remains absent", () => {
...
test("RSH-047 precreation fails closed", () => {
  const result = validateDaylightSky({
    repositoryFiles: ["RSH-047-PREFLIGHT.json", "src/game/ayalon-light/daylight.ts"],
  });
