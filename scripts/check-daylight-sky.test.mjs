...
test("committed RSH-031 daylight/sky/IBL lock passes and RSH-046 remains absent", () => {
...
test("RSH-046 precreation fails closed", () => {
  const result = validateDaylightSky({
    repositoryFiles: ["RSH-046-PREFLIGHT.json", "src/game/ayalon-light/daylight.ts"],
  });
