...
test("committed RSH-031 daylight/sky/IBL lock passes and RSH-037 remains absent", () => {
...
test("RSH-037 precreation fails closed", () => {
  const result = validateDaylightSky({
    repositoryFiles: ["RSH-037-PREFLIGHT.json", "src/game/ayalon-light/daylight.ts"],
  });
