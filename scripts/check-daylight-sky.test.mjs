...
test("committed RSH-031 daylight/sky/IBL lock passes and RSH-040 remains absent", () => {
...
test("RSH-040 precreation fails closed", () => {
  const result = validateDaylightSky({
    repositoryFiles: ["RSH-040-PREFLIGHT.json", "src/game/ayalon-light/daylight.ts"],
  });
