...
test("committed RSH-031 daylight/sky/IBL lock passes and RSH-032 remains absent", () => {
...
test("RSH-032 precreation fails closed", () => {
  const result = validateDaylightSky({
    repositoryFiles: ["RSH-032-PREFLIGHT.json", "src/game/ayalon-light/daylight.ts"],
  });
