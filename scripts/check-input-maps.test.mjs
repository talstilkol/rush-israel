...
test("committed RSH-044 lock passes and RSH-045 remains absent", () => {
...
test("RSH-044 does not accept an RTL-complete or public-distribution claim", () => {
  const verified = evaluateLock({ claimedRtlComplete: true });
