...
test("committed RSH-023 timed-record authority passes under the RSH-026 overlay and RSH-027 remains absent", () => {
...
test("RSH-027 precreation fails closed", () => {
  const result = validateTimedRecords({
    repositoryFiles: ["RSH-027-PREFLIGHT.json", "src/game/records.ts"],
  });
