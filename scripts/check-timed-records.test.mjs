...
test("committed RSH-023 timed-record authority passes under the RSH-029 overlay and RSH-039 remains absent", () => {
...
test("RSH-039 precreation fails closed", () => {
  const result = validateTimedRecords({
    repositoryFiles: ["RSH-039-PREFLIGHT.json", "src/game/records.ts"],
  });
