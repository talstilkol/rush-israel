...
test("committed RSH-023 timed-record authority passes under the RSH-029 overlay and RSH-036 remains absent", () => {
...
test("RSH-036 precreation fails closed", () => {
  const result = validateTimedRecords({
    repositoryFiles: ["RSH-036-PREFLIGHT.json", "src/game/records.ts"],
  });
