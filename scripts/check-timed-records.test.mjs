...
test("committed RSH-023 timed-record authority passes under the RSH-029 overlay and RSH-047 remains absent", () => {
...
test("RSH-047 precreation fails closed", () => {
  const result = validateTimedRecords({
    repositoryFiles: ["RSH-047-PREFLIGHT.json", "src/game/records.ts"],
  });
