...
test("committed RSH-023 timed-record authority passes under the RSH-029 overlay and RSH-045 remains absent", () => {
...
test("RSH-045 precreation fails closed", () => {
  const result = validateTimedRecords({
    repositoryFiles: ["RSH-045-PREFLIGHT.json", "src/game/records.ts"],
  });
