...
test("committed RSH-023 timed-record authority passes under the RSH-029 overlay and RSH-030 remains absent", () => {
...
test("RSH-030 precreation fails closed", () => {
  const result = validateTimedRecords({
    repositoryFiles: ["RSH-030-PREFLIGHT.json", "src/game/records.ts"],
  });
