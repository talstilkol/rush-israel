...
test("committed RSH-023 timed-record authority passes under the RSH-029 overlay and RSH-037 remains absent", () => {
...
test("RSH-037 precreation fails closed", () => {
  const result = validateTimedRecords({
    repositoryFiles: ["RSH-037-PREFLIGHT.json", "src/game/records.ts"],
  });
