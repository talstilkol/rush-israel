...
test("committed RSH-023 timed-record authority passes under the RSH-029 overlay and RSH-038 remains absent", () => {
...
test("RSH-038 precreation fails closed", () => {
  const result = validateTimedRecords({
    repositoryFiles: ["RSH-038-PREFLIGHT.json", "src/game/records.ts"],
  });
