...
test("committed RSH-023 timed-record authority passes under the RSH-029 overlay and RSH-035 remains absent", () => {
...
test("RSH-035 precreation fails closed", () => {
  const result = validateTimedRecords({
    repositoryFiles: ["RSH-035-PREFLIGHT.json", "src/game/records.ts"],
  });
