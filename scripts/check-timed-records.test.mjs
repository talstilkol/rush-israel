...
test("committed RSH-023 timed-record authority passes under the RSH-029 overlay and RSH-042 remains absent", () => {
...
test("RSH-042 precreation fails closed", () => {
  const result = validateTimedRecords({
    repositoryFiles: ["RSH-042-PREFLIGHT.json", "src/game/records.ts"],
  });
