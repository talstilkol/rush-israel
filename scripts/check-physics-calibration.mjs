...
export const EXPECTED_MANIFEST_SHA256 = "0456503e45c27cdf7c6e9fd6b7fb369d56fc7b7b656ed597a366a645a71c5900";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "80da1beae05f47f6c53c4ee7af94f02b767f593e0ba455811338b031dd516222";
...
export function validatePhysicsCalibration(overrides = {}) {
  ...
  if (
    manifest.deferred_boundary?.queue_head !== "RSH-047"
    ...
    || manifest.deferred_boundary?.rsh_034_started !== true || manifest.deferred_boundary?.rsh_035_started !== true || manifest.deferred_boundary?.rsh_036_started !== true || manifest.deferred_boundary?.rsh_037_started !== true || manifest.deferred_boundary?.rsh_038_started !== true || manifest.deferred_boundary?.rsh_039_started !== true || manifest.deferred_boundary?.rsh_040_started !== true || manifest.deferred_boundary?.rsh_041_started !== true || manifest.deferred_boundary?.rsh_042_started !== true || manifest.deferred_boundary?.rsh_043_started !== true || manifest.deferred_boundary?.rsh_045_started !== true || manifest.deferred_boundary?.rsh_046_started !== true || manifest.deferred_boundary?.rsh_047_started !== false
  ) {
    errors.push("RSH-047 deferred boundary changed");
  }
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`physics-calibration ok: PHYSICS_VERSION ${result.physicsVersion}; claims ${result.claims.join("/")}; RSH-047 deferred`);
}
