...
export const EXPECTED_MANIFEST_SHA256 = "8fb010cac77800c47485dbc359fc1ba66a25cbb0a4f99987765de565e001d5cc";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "ef14bbd117af8fbc82c52edf558e8907258f4e4e71559f6453e6091f5c22de57";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`physics-calibration ok: PHYSICS_VERSION ${result.physicsVersion}; claims ${result.claims.join("/")}; RSH-042 deferred`);
}
