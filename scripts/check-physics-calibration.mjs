...
export const EXPECTED_MANIFEST_SHA256 = "6d0b2f40843ef4e52083abf51e8fa3e8967622e665e9c8174c4d2b194ee50473";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "03ad0f3166560efd63ddc55985ba1154f69a667d7f8f88d0548c21855155f9dc";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`physics-calibration ok: PHYSICS_VERSION ${result.physicsVersion}; claims ${result.claims.join("/")}; RSH-045 deferred`);
}
