...
export const EXPECTED_MANIFEST_SHA256 = "efb5857c32c2615e6315d4fe10906af00dd325a0aaacf2d8d5e1268a1d0dc08b";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "cce04fecfd94d8f8173f7942a0185c4dbb37553de394e70e4b373cd31e931877";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`physics-calibration ok: PHYSICS_VERSION ${result.physicsVersion}; claims ${result.claims.join("/")}; RSH-046 deferred`);
}
