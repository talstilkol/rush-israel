...
test("committed RSH-027 Ayalon collider lock passes under the RSH-029 overlay and RSH-035 remains absent", () => {
...
test("RSH-035 precreation fails closed", () => {
  const result = validateAyalonColliders({
    repositoryFiles: ["RSH-035-PREFLIGHT.json", "src/game/ayalon-colliders/colliders.ts"],
  });
