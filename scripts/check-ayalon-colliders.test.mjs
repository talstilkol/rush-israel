...
test("committed RSH-027 Ayalon collider lock passes under the RSH-029 overlay and RSH-030 remains absent", () => {
...
test("RSH-030 precreation fails closed", () => {
  const result = validateAyalonColliders({
    repositoryFiles: ["RSH-030-PREFLIGHT.json", "src/game/ayalon-colliders/colliders.ts"],
  });
