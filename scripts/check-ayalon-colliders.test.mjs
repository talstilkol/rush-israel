...
test("committed RSH-027 Ayalon collider lock passes under the RSH-029 overlay and RSH-044 remains absent", () => {
...
test("RSH-044 precreation fails closed", () => {
  const result = validateAyalonColliders({
    repositoryFiles: ["RSH-044-PREFLIGHT.json", "src/game/ayalon-colliders/colliders.ts"],
  });
