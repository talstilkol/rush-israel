...
test("committed RSH-027 Ayalon collider lock passes under the RSH-029 overlay and RSH-031 remains absent", () => {
...
test("RSH-031 precreation fails closed", () => {
  const result = validateAyalonColliders({
    repositoryFiles: ["RSH-031-PREFLIGHT.json", "src/game/ayalon-colliders/colliders.ts"],
  });
