...
test("committed RSH-027 Ayalon collider lock passes under the RSH-029 overlay and RSH-036 remains absent", () => {
...
test("RSH-036 precreation fails closed", () => {
  const result = validateAyalonColliders({
    repositoryFiles: ["RSH-036-PREFLIGHT.json", "src/game/ayalon-colliders/colliders.ts"],
  });
