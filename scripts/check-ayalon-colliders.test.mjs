...
test("committed RSH-027 Ayalon collider lock passes under the RSH-029 overlay and RSH-045 remains absent", () => {
...
test("RSH-045 precreation fails closed", () => {
  const result = validateAyalonColliders({
    repositoryFiles: ["RSH-045-PREFLIGHT.json", "src/game/ayalon-colliders/colliders.ts"],
  });
