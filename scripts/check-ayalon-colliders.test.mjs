...
test("committed RSH-027 Ayalon collider lock passes under the RSH-029 overlay and RSH-037 remains absent", () => {
...
test("RSH-037 precreation fails closed", () => {
  const result = validateAyalonColliders({
    repositoryFiles: ["RSH-037-PREFLIGHT.json", "src/game/ayalon-colliders/colliders.ts"],
  });
