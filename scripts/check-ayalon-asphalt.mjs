...
export const EXPECTED_MANIFEST_SHA256 = "93447d2b99b829c53d962ea35944b4c9b5419084ab3f1d23dbb268d6af25bac0";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "8701d801db2d5c0d892cfd4a8d7eb0d7744ed6e7196f9afea3f4e871eb91b2ac";
...
export function validateAyalonAsphalt(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-030" || manifest.deferred_boundary?.rsh_030_authorized !== false || manifest.deferred_boundary?.rsh_030_started !== false) errors.push("RSH-030 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`ayalon-asphalt ok: ${result.trackId}; ${result.lanes} lanes; sidewalks ${result.sidewalkPresent}; ${result.gantryCount} gantries; ${result.stationGantryCount} station gantries; RSH-030 deferred`);
}
