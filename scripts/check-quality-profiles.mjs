...
export const EXPECTED_MANIFEST_SHA256 = "f80f64468c6562704dd0e4487699257ba9684a5a7b6bc01f3c4865bc382b5ed8";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "7d276724f5c2186fcacdd6cf40ef060433b52c354d8b3b1643423fb8fb2802ae";
...
export function validateQualityProfiles(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-047" || manifest.deferred_boundary?.rsh_039_authorized !== true || manifest.deferred_boundary?.rsh_040_authorized !== true || manifest.deferred_boundary?.rsh_041_authorized !== true || manifest.deferred_boundary?.rsh_042_authorized !== true || manifest.deferred_boundary?.rsh_043_authorized !== true || manifest.deferred_boundary?.rsh_045_authorized !== true || manifest.deferred_boundary?.rsh_046_authorized !== true || manifest.deferred_boundary?.rsh_047_authorized !== false || manifest.deferred_boundary?.rsh_039_started !== true || manifest.deferred_boundary?.rsh_040_started !== true || manifest.deferred_boundary?.rsh_041_started !== true || manifest.deferred_boundary?.rsh_042_started !== true || manifest.deferred_boundary?.rsh_043_started !== true || manifest.deferred_boundary?.rsh_045_started !== true || manifest.deferred_boundary?.rsh_046_started !== true || manifest.deferred_boundary?.rsh_047_started !== false) errors.push("RSH-047 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`quality-profiles ok: 5 profiles + hysteresis; RSH-047 deferred`);
}
