...
export const EXPECTED_MANIFEST_SHA256 = "fe51ae88ce8e7619e377cf74f4b2b6f86afe4f21976d22eb476d1cbdd5f69474";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "b49d2fcab9050580198c82daa301d2d5329eadf704dc2334b9e3473805f975c4";
...
export function validateQualityProfiles(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-041" || manifest.deferred_boundary?.rsh_039_authorized !== true || manifest.deferred_boundary?.rsh_040_authorized !== true || manifest.deferred_boundary?.rsh_041_authorized !== false || manifest.deferred_boundary?.rsh_039_started !== true || manifest.deferred_boundary?.rsh_040_started !== true || manifest.deferred_boundary?.rsh_041_started !== false) errors.push("RSH-041 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`quality-profiles ok: 5 profiles + hysteresis; RSH-041 deferred`);
}
