...
export const EXPECTED_MANIFEST_SHA256 = "b3f621f6dc28de96ae2b3529465e3eeab2059dc5b4fcc2497fe3a3274419950b";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "281f618cf4e855583d141ba94262c96d017d71d8cdf99ea1dec5c669504e2c8e";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`hero-car ok: ${result.carCount} fictional cars; scanned ${result.scanned}; LOD0 cap ${result.lod0}; RSH-047 deferred`);
}
