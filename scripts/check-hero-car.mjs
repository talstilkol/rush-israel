...
export const EXPECTED_MANIFEST_SHA256 = "0a1f28540b26c0632e02e52d92ff797abdbe62fca9659d167ad0cbaf848cb723";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "a0827a93fd818d3c29f35574be804e0be2a1f1c945b4fc6e7046559c2bea6692";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`hero-car ok: ${result.carCount} fictional cars; scanned ${result.scanned}; LOD0 cap ${result.lod0}; RSH-042 deferred`);
}
