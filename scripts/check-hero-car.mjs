...
export const EXPECTED_MANIFEST_SHA256 = "8db541747f9f3eb2c49561ac58d9a36e675b6ac26abf9d079018f51d86268200";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "91bd3ecf2a107edf40bad7f0a913258c3e5053eeb2e7070d136cd1454dce9109";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`hero-car ok: ${result.carCount} fictional cars; scanned ${result.scanned}; LOD0 cap ${result.lod0}; RSH-040 deferred`);
}
