...
export const EXPECTED_MANIFEST_SHA256 = "5ba5caaef18e86e0c7a160f132a4aa3a103d29877ccee1f1f08958919ab6b874";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "c530b72a973d51cad9eb2c2b6c9eea54d1e3c0a49b0d5a843e17e1f670e5ed2d";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`hero-car ok: ${result.carCount} fictional cars; scanned ${result.scanned}; LOD0 cap ${result.lod0}; RSH-041 deferred`);
}
