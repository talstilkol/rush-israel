...
export const EXPECTED_MANIFEST_SHA256 = "f46c94fd471bca905d071546bd8ccb53b667029e9e2051fd3a40ca5dc3ac949d";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "db354dccff3eaaa15b1ece377961ac4389a06689999206e9cafd4ba0e242e25f";
...
export function validateHeroCar(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-031" || manifest.deferred_boundary?.rsh_031_authorized !== false || manifest.deferred_boundary?.rsh_031_started !== false) errors.push("RSH-031 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`hero-car ok: ${result.carCount} fictional cars; scanned ${result.scanned}; LOD0 cap ${result.lod0}; RSH-031 deferred`);
}
