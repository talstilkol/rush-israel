...
export const EXPECTED_MANIFEST_SHA256 = "d4cf7ad34e8ec7f26b07e7a0bacf9ba49ae950a282a26668429b7f207a00ebf5";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "4a4f54b917b1d09e4ff8c4e42dc414019084a05bbb37bf9ce77c6152e22681a2";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`hero-car ok: ${result.carCount} fictional cars; scanned ${result.scanned}; LOD0 cap ${result.lod0}; RSH-043 deferred`);
}
