...
export const EXPECTED_MANIFEST_SHA256 = "d521264406476846c4c5ff439085ff304bdf73a3fa3173e4b65d0c90b7405234";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "979a20026048a4370114e68a227532cab97469f32cd04877006da668e359a934";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`hero-car ok: ${result.carCount} fictional cars; scanned ${result.scanned}; LOD0 cap ${result.lod0}; RSH-044 deferred`);
}
