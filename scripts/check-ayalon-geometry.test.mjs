...
test("committed RSH-026 Ayalon geometry lock passes under the RSH-029 overlay and RSH-045 remains absent", () => {
...
test("RSH-045 precreation fails closed", () => {
  const result = validateAyalonGeometry({
    repositoryFiles: ["RSH-045-PREFLIGHT.json", "src/game/ayalon-lock/geometry.ts"],
  });
