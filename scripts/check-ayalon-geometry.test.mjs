...
test("committed RSH-026 Ayalon geometry lock passes under the RSH-029 overlay and RSH-044 remains absent", () => {
...
test("RSH-044 precreation fails closed", () => {
  const result = validateAyalonGeometry({
    repositoryFiles: ["RSH-044-PREFLIGHT.json", "src/game/ayalon-lock/geometry.ts"],
  });
