...
test("committed RSH-026 Ayalon geometry lock passes under the RSH-029 overlay and RSH-030 remains absent", () => {
...
test("RSH-030 precreation fails closed", () => {
  const result = validateAyalonGeometry({
    repositoryFiles: ["RSH-030-PREFLIGHT.json", "src/game/ayalon-lock/geometry.ts"],
  });
