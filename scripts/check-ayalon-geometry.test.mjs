...
test("committed RSH-026 Ayalon geometry lock passes under the RSH-029 overlay and RSH-037 remains absent", () => {
...
test("RSH-037 precreation fails closed", () => {
  const result = validateAyalonGeometry({
    repositoryFiles: ["RSH-037-PREFLIGHT.json", "src/game/ayalon-lock/geometry.ts"],
  });
