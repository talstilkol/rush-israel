...
export const EXPECTED_MANIFEST_SHA256 = "2c8b5ee25b0bfe2f11a44de6413c8256cbd8435c8d5c900f05ba7062900087aa";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "6e73b866503e10adab9db6a73b540ff06b5a800bfbcfc137d180173ff4ae14a5";
...
export function validateThirtySoak(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-046" || manifest.deferred_boundary?.rsh_043_authorized !== true || manifest.deferred_boundary?.rsh_045_authorized !== true || manifest.deferred_boundary?.rsh_046_authorized !== false || manifest.deferred_boundary?.rsh_043_started !== true || manifest.deferred_boundary?.rsh_045_started !== true || manifest.deferred_boundary?.rsh_046_started !== false) errors.push("RSH-046 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`thirty-soak ok: 1800s wall-clock soak-30min locked; smoke does not substitute; RSH-046 deferred`);
}
