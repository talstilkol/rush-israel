...
export const EXPECTED_MANIFEST_SHA256 = "fd14a5a784f9fd88fb1e4a3c6136de66bf1edb87e7e1854f1886fa7c6f4c5ed7";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "556393a691f1d365237c154c89ae015122f8147b41e193c040dfa6adfbb7c4d7";
...
export function validateThirtySoak(overrides = {}) {
  ...
  if (manifest.deferred_boundary?.queue_head !== "RSH-047" || manifest.deferred_boundary?.rsh_043_authorized !== true || manifest.deferred_boundary?.rsh_045_authorized !== true || manifest.deferred_boundary?.rsh_046_authorized !== true || manifest.deferred_boundary?.rsh_047_authorized !== false || manifest.deferred_boundary?.rsh_043_started !== true || manifest.deferred_boundary?.rsh_045_started !== true || manifest.deferred_boundary?.rsh_046_started !== true || manifest.deferred_boundary?.rsh_047_started !== false) errors.push("RSH-047 deferred boundary changed");
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`thirty-soak ok: 1800s wall-clock soak-30min locked; smoke does not substitute; RSH-047 deferred`);
}
