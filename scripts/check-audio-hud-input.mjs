...
export const EXPECTED_MANIFEST_SHA256 = "5b676d8f87e7cff7d34f95febc5e07767b61481ef6e5d992c8b058f2e36aae7e";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "4aadcae12d5ceccf6f85141cf90c769389f6d3d9914d6f4e7fa5cb235280a6cf";
...
export function validateAudioHudInput(overrides = {}) {
  ...
  if (
    ...
    || manifest.deferred_boundary?.rsh_035_authorized !== true || manifest.deferred_boundary?.rsh_036_authorized !== true || manifest.deferred_boundary?.rsh_037_authorized !== true || manifest.deferred_boundary?.rsh_038_authorized !== true || manifest.deferred_boundary?.rsh_039_authorized !== false
    || manifest.deferred_boundary?.rsh_035_started !== true || manifest.deferred_boundary?.rsh_036_started !== true || manifest.deferred_boundary?.rsh_037_started !== true || manifest.deferred_boundary?.rsh_038_started !== true || manifest.deferred_boundary?.rsh_039_started !== false
  ) {
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`audio-hud-input ok: backend ${result.backend}; radio ${result.radioCount}; speed ${result.speedScale}; RSH-039 deferred`);
}
