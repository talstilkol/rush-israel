...
export const EXPECTED_MANIFEST_SHA256 = "f95d18a8f7ed287ff3b03e2dfd62174e036230c6124f4c22917aa09e7f91c62f";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "5199eb8b17dd20274764e0321f9aeb08c9cc177a833e776974d4be8168d015f4";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`audio-hud-input ok: backend ${result.backend}; radio ${result.radioCount}; speed ${result.speedScale}; RSH-047 deferred`);
}
