...
export const EXPECTED_MANIFEST_SHA256 = "fda4125baffd657a877f3ee9beae970bc08e81107c44657aaae2b8a375a88440";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "a2ca313953ca14efb31f7c76f46487f1f13d65749faf59db8272d9f713d3c3ba";
...
export function validateAudioHudInput(overrides = {}) {
  ...
  if (
    ...
    || manifest.deferred_boundary?.rsh_035_authorized !== true || manifest.deferred_boundary?.rsh_036_authorized !== true || manifest.deferred_boundary?.rsh_037_authorized !== true || manifest.deferred_boundary?.rsh_038_authorized !== false
    || manifest.deferred_boundary?.rsh_035_started !== true || manifest.deferred_boundary?.rsh_036_started !== true || manifest.deferred_boundary?.rsh_037_started !== true || manifest.deferred_boundary?.rsh_038_started !== false
  ) {
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`audio-hud-input ok: backend ${result.backend}; radio ${result.radioCount}; speed ${result.speedScale}; RSH-038 deferred`);
}
