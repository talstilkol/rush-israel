...
export const EXPECTED_MANIFEST_SHA256 = "9e5a78b20fbc86e8748eb852e3e1f8019a7a9c6e6ddb2217c9d92128df8cd46f";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "e4c59c032fe5af27aa154b8a4a561f50d70da2c92b1b4c62e1b516a4739759e5";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`audio-hud-input ok: backend ${result.backend}; radio ${result.radioCount}; speed ${result.speedScale}; RSH-041 deferred`);
}
