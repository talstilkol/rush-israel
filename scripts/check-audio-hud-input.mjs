...
export const EXPECTED_MANIFEST_SHA256 = "5c3c2e049fca0b5e035bb39c32037192472177f2a3d3a6b6388048816cdbc1e0";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "5de03a9a03fe6c296cf1373aede6d9bf827d530491687695834f2c9aa402ecb5";
...
export function validateAudioHudInput(overrides = {}) {
  ...
  if (
    ...
    || manifest.deferred_boundary?.rsh_035_started !== true || manifest.deferred_boundary?.rsh_036_started !== true || manifest.deferred_boundary?.rsh_037_started !== true || manifest.deferred_boundary?.rsh_038_started !== true || manifest.deferred_boundary?.rsh_039_started !== true || manifest.deferred_boundary?.rsh_040_started !== false
  ) {
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`audio-hud-input ok: backend ${result.backend}; radio ${result.radioCount}; speed ${result.speedScale}; RSH-040 deferred`);
}
