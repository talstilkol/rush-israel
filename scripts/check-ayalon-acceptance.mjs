...
export const EXPECTED_MANIFEST_SHA256 = "75f532bc38674ef459023d4c1179c66e9632a16ba0c0362f96f9b9b7d7b91aef";
...
export const EXPECTED_CHECKER_TEST_SHA256 = "b37e2a4b52cdd1f2ce1bbcf9c13b0486c046ce5154ceb3bd0b7955ea678834e2";
...
if (isMainModule(import.meta.url)) {
  ...
  console.log(`ayalon-acceptance ok: ${result.trackId}; ${result.packFiles} pack files; ${result.duplicatePlaceholders} duplicate placeholders; RSH-028 deferred`);
}
