...
export const EXPECTED_MANIFEST_SHA256 = "ee926304e88044a168991db934be452c8e31918ba2298d0c9e2e146886ee1f9c";
...
export function validateSaveSchema(overrides = {}) {
  ...
  if (sha256(input.testSource) !== EXPECTED_RSH026_SCHEMA_GUARD_TEST_SHA256 || manifest.rsh_026_overlay.schema_guard_test_sha256 !== EXPECTED_RSH026_SCHEMA_GUARD_TEST_SHA256) errors.push("RSH-026 schema-guard test identity changed");
  ...
  if (manifest.deferred_boundary.queue_head !== "RSH-027" || manifest.deferred_boundary.rsh_022_started !== true || manifest.deferred_boundary.rsh_022_authorized !== true || manifest.deferred_boundary.rsh_022_state !== "accepted_on_merge" || manifest.deferred_boundary.rsh_023_started !== true || manifest.deferred_boundary.rsh_023_authorized !== true || manifest.deferred_boundary.rsh_024_started !== true || manifest.deferred_boundary.rsh_024_authorized !== true || manifest.deferred_boundary.rsh_025_started !== true || manifest.deferred_boundary.rsh_025_authorized !== true || manifest.deferred_boundary.rsh_026_started !== true || manifest.deferred_boundary.rsh_026_authorized !== true || manifest.deferred_boundary.rsh_027_started !== false || manifest.deferred_boundary.rsh_027_authorized !== false) errors.push("RSH-027 deferred boundary changed");
