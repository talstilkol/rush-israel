...
export const EXPECTED_MANIFEST_SHA256 = "0cbde135f99898c8d204c843a1df1d757ef02f685ec9c3bc061a362eee2addc3";
...
export const EXPECTED_RSH035_SCHEMA_GUARD_TEST_SHA256 = "3cf3fce5d44e19daadb526dadce5ebe6d5ebc9f400cee39ecea275ff38ce0a8d";
...
export function validateSaveSchema(overrides = {}) {
  ...
  if (later.length) errors.push("RSH-041 was precreated: " + later.join(", "));
