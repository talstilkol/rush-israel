...
export const EXPECTED_MANIFEST_SHA256 = "49eaf009eacf3c577af57fcd1359475509a45a89d34fc8f51c684d8e6b4c80f6";
...
export function validateSaveSchema(overrides = {}) {
  ...
  if (sha256(input.testSource) !== EXPECTED_RSH028_SCHEMA_GUARD_TEST_SHA256 || manifest.rsh_028_overlay.schema_guard_test_sha256 !== EXPECTED_RSH028_SCHEMA_GUARD_TEST_SHA256) errors.push("RSH-028 schema-guard test identity changed");
  ...
  if (manifest.deferred_boundary.queue_head !== "RSH-029" || manifest.deferred_boundary.rsh_022_started !== true || manifest.deferred_boundary.rsh_022_authorized !== true || manifest.deferred_boundary.rsh_022_state !== "accepted_on_merge" || manifest.deferred_boundary.rsh_023_started !== true || manifest.deferred_boundary.rsh_023_authorized !== true || manifest.deferred_boundary.rsh_024_started !== true || manifest.deferred_boundary.rsh_024_authorized !== true || manifest.deferred_boundary.rsh_025_started !== true || manifest.deferred_boundary.rsh_025_authorized !== true || manifest.deferred_boundary.rsh_026_started !== true || manifest.deferred_boundary.rsh_026_authorized !== true || manifest.deferred_boundary.rsh_027_started !== true || manifest.deferred_boundary.rsh_027_authorized !== true || manifest.deferred_boundary.rsh_028_started !== true || manifest.deferred_boundary.rsh_028_authorized !== true || manifest.deferred_boundary.rsh_029_started !== false || manifest.deferred_boundary.rsh_029_authorized !== false) errors.push("RSH-029 deferred boundary changed");
