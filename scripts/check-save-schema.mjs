...
export const EXPECTED_MANIFEST_SHA256 = "2a8e9c45d954e916d4676cfe621180f3f1cf8b6bf644d3e33a9f13f7d79a60bc";
...
export function validateSaveSchema(overrides = {}) {
  ...
  if (sha256(input.testSource) !== EXPECTED_RSH029_SCHEMA_GUARD_TEST_SHA256 || manifest.rsh_029_overlay.schema_guard_test_sha256 !== EXPECTED_RSH029_SCHEMA_GUARD_TEST_SHA256) errors.push("RSH-029 schema-guard test identity changed");
  ...
  if (manifest.deferred_boundary.queue_head !== "RSH-030" || manifest.deferred_boundary.rsh_022_started !== true || manifest.deferred_boundary.rsh_022_authorized !== true || manifest.deferred_boundary.rsh_022_state !== "accepted_on_merge" || manifest.deferred_boundary.rsh_023_started !== true || manifest.deferred_boundary.rsh_023_authorized !== true || manifest.deferred_boundary.rsh_024_started !== true || manifest.deferred_boundary.rsh_024_authorized !== true || manifest.deferred_boundary.rsh_025_started !== true || manifest.deferred_boundary.rsh_025_authorized !== true || manifest.deferred_boundary.rsh_026_started !== true || manifest.deferred_boundary.rsh_026_authorized !== true || manifest.deferred_boundary.rsh_027_started !== true || manifest.deferred_boundary.rsh_027_authorized !== true || manifest.deferred_boundary.rsh_028_started !== true || manifest.deferred_boundary.rsh_028_authorized !== true || manifest.deferred_boundary.rsh_029_started !== true || manifest.deferred_boundary.rsh_029_authorized !== true || manifest.deferred_boundary.rsh_030_started !== false || manifest.deferred_boundary.rsh_030_authorized !== false) errors.push("RSH-030 deferred boundary changed");
