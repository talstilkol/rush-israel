...
export const EXPECTED_MANIFEST_SHA256 = "928240f6f59421a2a2d473f299c3c07e7fa09108378136dfeb5628aaa028a00c";
...
export function validateSaveSchema(overrides = {}) {
  ...
  if (sha256(input.testSource) !== EXPECTED_RSH032_SCHEMA_GUARD_TEST_SHA256 || manifest.rsh_032_overlay.schema_guard_test_sha256 !== EXPECTED_RSH032_SCHEMA_GUARD_TEST_SHA256) errors.push("RSH-032 schema-guard test identity changed");
