...
export const EXPECTED_MANIFEST_SHA256 = "65e8ae86f2e3a7fa9fe516df33c3f898fca398ce7df744d328ba2048348e283d";
...
export function validateSaveSchema(overrides = {}) {
  ...
  if (sha256(input.testSource) !== EXPECTED_RSH034_SCHEMA_GUARD_TEST_SHA256 || manifest.rsh_034_overlay.schema_guard_test_sha256 !== EXPECTED_RSH034_SCHEMA_GUARD_TEST_SHA256) errors.push("RSH-034 schema-guard test identity changed");
