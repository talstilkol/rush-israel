...
export const EXPECTED_MANIFEST_SHA256 = "f97038c8e91bfcbbb1d01385adf444ab0a9782cc82aa350b40da9eced16e12d1";
...
export const EXPECTED_RSH035_SCHEMA_GUARD_TEST_SHA256 = "f1a39d5dd2668474edefc273278953eefe642e48efaa977a5c6ac129c9261083";
...
export function validateSaveSchema(overrides = {}) {
  ...
  if (later.length) errors.push("RSH-042 was precreated: " + later.join(", "));
