...
export const EXPECTED_MANIFEST_SHA256 = "4fb842bf5cb59f2040bf0394d95145985e4d24bd36152d46d3c06fc58d3b5f6d";
...
export const EXPECTED_RSH036_SCHEMA_GUARD_TEST_SHA256 = "b55158f16f39c2b3290c3a3c2d9d8675a1845decf9d8d267cd39545ae5a58a78";
export const EXPECTED_RSH035_SCHEMA_GUARD_TEST_SHA256 = "0cc52a3b1e19ff02d8923d82303f52cb6b79b0e4928c5ba5ff629cec4eec7ba5";
...
export function validateSaveSchema(overrides = {}) {
  ...
  if (sha256(input.testSource) !== EXPECTED_RSH036_SCHEMA_GUARD_TEST_SHA256 || manifest.rsh_036_overlay.schema_guard_test_sha256 !== EXPECTED_RSH036_SCHEMA_GUARD_TEST_SHA256) errors.push("RSH-036 schema-guard test identity changed");
  if (manifest.rsh_035_overlay.schema_guard_test_sha256 !== EXPECTED_RSH035_SCHEMA_GUARD_TEST_SHA256) errors.push("RSH-035 historical schema-guard test identity changed");
