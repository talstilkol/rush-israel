...
export const EXPECTED_MANIFEST_SHA256 = "5ca88543550255e6ed7da9a3ca8a7d8aecad88ce3ff5a8611e4519572be854f5";
...
export function validateSaveSchema(overrides = {}) {
  ...
  if (sha256(input.testSource) !== EXPECTED_RSH027_SCHEMA_GUARD_TEST_SHA256 || manifest.rsh_027_overlay.schema_guard_test_sha256 !== EXPECTED_RSH027_SCHEMA_GUARD_TEST_SHA256) errors.push("RSH-027 schema-guard test identity changed");
  ...
  if (manifest.deferred_boundary.queue_head !== "RSH-028" || manifest.deferred_boundary.rsh_022_started !== true || manifest.deferred_boundary.rsh_022_authorized !== true || manifest.deferred_boundary.rsh_022_state !== "accepted_on_merge" || manifest.deferred_boundary.rsh_023_started !== true || manifest.deferred_boundary.rsh_023_authorized !== true || manifest.deferred_boundary.rsh_024_started !== true || manifest.deferred_boundary.rsh_024_authorized !== true || manifest.deferred_boundary.rsh_025_started !== true || manifest.deferred_boundary.rsh_025_authorized !== true || manifest.deferred_boundary.rsh_026_started !== true || manifest.deferred_boundary.rsh_026_authorized !== true || manifest.deferred_boundary.rsh_027_started !== true || manifest.deferred_boundary.rsh_027_authorized !== true || manifest.deferred_boundary.rsh_028_started !== false || manifest.deferred_boundary.rsh_028_authorized !== false) errors.push("RSH-028 deferred boundary changed");
